ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Značka krátké zóny
	LanguageRegionLink              = Regionálního sdružení
	LanguageNoSelect                = Zobrazit známé jazyky po výběru zdroje obrázku
	...
	LanguageExtractSearchResult     = Výsledky vyhledávání
	LanguageExtractSearchResultNO   = Žádné odpovídající výsledky
	LanguageExtractSearchResultTips = Vyberte jazyk, klikněte na tlačítko "Vyhledat a porovnat" a zkontrolujte, zda je obsah jazyka, který chcete přidat, konzistentní. Pokud ano, kliknutím na tlačítko "Importovat" zobrazíte okamžité výsledky.
	LanguageExtractSearch           = Hledejte a spojujte
	LanguageExtractAddTo            = Importovat
	LanguageExtractTo               = Po importu přidat do:
'@