...
Function Image_Eject_UI
{
	...
	$UI_Main_Mask_Rule_Detailed_OK_Click = {
	...
	$UI_Main_Mask_Rule_Detailed_OK_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "620,595"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		add_Click      = $UI_Main_Mask_Rule_Detailed_OK_Click
	}
	$UI_Main_Mask_Rule_Detailed_OK = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 255
		Location       = "646,597"
		Text           = $lang.OK
	...
	$UI_Main_Mask_Rule_Detailed_Hide_Click = {
		$UI_Main_Mask_Rule_Detailed.Visible = $False
	}
	$UI_Main_Mask_Rule_Detailed_Hide_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Mask_Rule_Detailed_Hide_Click
	}
	...
	$UI_Main_Mask_Rule_Detailed.controls.AddRange((
		$UI_Main_Expand_Menu,
		$UI_Main_Expand_Tips,
		$UI_Main_Mask_Rule_Detailed_OK_ICO,
