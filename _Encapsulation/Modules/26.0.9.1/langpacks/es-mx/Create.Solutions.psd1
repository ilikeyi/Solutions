ConvertFrom-StringData -StringData @'
	...
	VerifyNameTips                  = Sólo se permite una combinación de letras y números en inglés y no puede contener: espacios, la longitud no puede ser superior a 260 caracteres, \\ / : * & @ !
	...
	Command_Not_Class               = No más clasificación automática al filtrar
	Command_WinSetup                = Instalación de windows
	Command_WinPE                   = Windows PE
	Command_Tips                    = Asigne la aplicación First Run a: Instalación de Windows, Windows PE\n\nTenga en cuenta que cuando se agrega un motor de implementación, debe verificar lo siguiente cuando se ejecuta por primera vez: Política de ejecución de Powershell: restringida, permite que se ejecuten scripts del motor de implementación.
