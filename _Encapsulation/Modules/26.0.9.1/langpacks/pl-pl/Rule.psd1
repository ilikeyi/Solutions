ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Krótki znak strefy
	LanguageRegionLink              = Stowarzyszenie regionalne
	LanguageNoSelect                = Pokaż znane języki po wybraniu źródła obrazu
	...
	LanguageExtractSearchResult     = Wyniki wyszukiwania
	LanguageExtractSearchResultNO   = Brak pasujących wyników
	LanguageExtractSearchResultTips = Wybierz język, kliknij przycisk "Wyszukaj i dopasuj" i sprawdź, czy treść językowa, którą chcesz dodać, jest spójna. Jeśli tak, kliknij przycisk "Importuj", aby wyświetlić natychmiastowe wyniki.
	LanguageExtractSearch           = Wyszukaj i dopasuj
	LanguageExtractTo               = Po zaimportowaniu dodaj do:
'@