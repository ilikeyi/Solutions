ConvertFrom-StringData -StringData @'
	...
	Other_Tasks_Clear               = Effacer nionso oyo esalemi
	Other_Tasks_Empty               = Mosala ya mpamba
	Other_Tasks_Pause               = Kopema
	Other_Tasks_RAMDISK             = Luka ba volumes nionso ya disque local na RADMDISK et puis formater yango
	Other_Tasks_RAMDISK_AR          = Tüm yerel disk birimlerini RADMDISK ile arayın ve ardından bunları biçimlendirin + otomatik olarak onarın
	Other_Tasks_REFS                = WinPE ebakisi lisungi ya installation ya REFS
	Other_Tasks_TPM                 = Bypass vérification ya installation ya TPM
'@