ConvertFrom-StringData -StringData @'
	...
	SearchOrder               = 搜索顺序
	SearchOrderTips           = 搜索顺序\n  满足 [ 1.  2. ] 项后，关闭继续搜索，不满足则继续搜索。\n\n\n1. 索引号\n   搜索 [ 添加来源 ]\\Custom\\[ 匹配当前已挂载的索引号 ]，匹配到添加，关闭搜索；\n\n2. 映像标志\n   搜索 [ 添加来源 ]\\Custom\\[ 获取当前挂载映像标志 ]，匹配到添加，关闭搜索；\n\n3. 其它\n   未满足 12 项，默认添加来源所有文件（排除来源里的 Custom 目录）。
'@