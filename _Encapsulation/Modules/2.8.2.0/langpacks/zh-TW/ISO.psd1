ConvertFrom-StringData -StringData @'
	...
	PublicYear                      = 年
	PublicMonth                     = 月
	PublicYMSorting                 = 排序："月年" 改成 "年月"
	PublicYMSortingTips             = AB 使用數字時不加 _ 符號。
	PublicYMUseShortNames           = 使用短名稱
	PublicYMUseNumbers              = 使用數字
	...
	CreateASCPwd                    = 證書密碼
	PasswordRenter                  = 重新輸入密碼
	ShowPassword                    = 顯示密碼
	NewPasswordSome                 = 密碼不一致。
	PwdPermanent                    = 永遠保存
	PwdDecfailed                    = 解密失敗
	CreateASCAuthor                 = 簽署者
	CreateASCAuthorTips             = 未選擇簽署者。
	ISO_Sparse_Rename               = 將哈稀加到檔案名稱後綴
