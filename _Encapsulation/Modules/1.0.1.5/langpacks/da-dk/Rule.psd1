ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Kort zonemærke
	LanguageRegionLink              = Regionsforening
	LanguageNoSelect                = Vis kendte sprog efter valg af billedkilde
	...
	LanguageExtractSearchResult     = Søgeresultater
	LanguageExtractSearchResultNO   = Ingen matchende resultater
	LanguageExtractSearchResultTips = Vælg et sprog, klik på knappen "Søg og match", og kontroller, om det sprogindhold, du vil tilføje, er konsistent. Hvis det er tilfældet, skal du klikke på knappen "Importer" for at få vist resultater med det samme.
	LanguageExtractSearch           = Søg og match
	LanguageExtractAddTo            = Importere
	LanguageExtractTo               = Efter import tilføj til:
'@