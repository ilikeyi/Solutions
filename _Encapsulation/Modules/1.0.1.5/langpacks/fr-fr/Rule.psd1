ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Marque de zone courte
	LanguageRegionLink              = Association régionale
	LanguageNoSelect                = Afficher les langues connues après avoir sélectionné la source de l'image
	...
	LanguageExtractSearchResult     = Résultats de la recherche
	LanguageExtractSearchResultNO   = Aucun résultat correspondant
	LanguageExtractSearchResultTips = Sélectionnez la langue, cliquez sur le bouton "Rechercher et faire correspondre" et vérifiez si le contenu linguistique que vous souhaitez ajouter est cohérent. Si tel est le cas, cliquez sur le bouton "Importer" pour afficher les résultats instantanés.
	LanguageExtractSearch           = Rechercher et faire correspondre
	LanguageExtractAddTo            = Importer
	LanguageExtractTo               = Après l'importation, ajoutez à:
'@