...
$Global:SMExt = GetSupportedWIMTypes
...
Function Image_Select
{
	...
	Function Exclude_Add_Ramdisk
	{
		<#
			.获取 RAMDISK 卷标名
		#>
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\RAMDisk" -Name "RAMDisk_Volume_Label" -ErrorAction SilentlyContinue) {
			<#
				.从注册表获取卷标名
			#>
			if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\RAMDisk" -Name "RAMDisk_Volume_Label" -ErrorAction SilentlyContinue) {
				$CustomRAMDISKLabel = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\RAMDisk" -Name "RAMDisk_Volume_Label" -ErrorAction SilentlyContinue
	...
	Function Image_Setting_UI
	{
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\RAMDisk" -Name "RAMDisk" -ErrorAction SilentlyContinue) {
			...
			Save_Dynamic -regkey "Solutions\RAMDisk" -name "RAMDisk" -value "True" -String
			$GUIImageSourceSetting_RAMDISK_Volume_Label.Enabled = $True
			$GUIImageSource_Setting_RAMDISK_Change.Enabled = $True
			$GUIImageSource_Setting_RAMDISK_Restore.Enabled = $True
			$GUIImageSource_Setting_Abandon_Allow_Auto.Enabled = $True
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions" -Name "Abandon_Allow_Auto" -ErrorAction SilentlyContinue) {
			...
			$GUIImageSource_Setting_Abandon_Allow_Auto.Checked = $True
			Save_Dynamic -regkey "Solutions" -name "Abandon_Allow_Auto" -value "True" -String
		}
		...
		#>
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\RAMDisk" -Name "RAMDisk_Exclude" -ErrorAction SilentlyContinue) {
			switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\RAMDisk" -Name "RAMDisk_Exclude" -ErrorAction SilentlyContinue) {
				"True" {
			...
			$GUIImageSource_Setting_RAMDISK_Exclude.Checked = $True
			Save_Dynamic -regkey "Solutions\RAMDisk" -name "RAMDisk_Exclude" -value "True" -String
		}
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions\RAMDisk" -Name "RAMDisk_Volume_Label" -ErrorAction SilentlyContinue) {
			...
			Save_Dynamic -regkey "Solutions\RAMDisk" -name "RAMDisk_Volume_Label" -value $Global:Init_RAMDISK_Volume_Label -String
	...
	Function Image_Select_Refresh_Sources_Setting
	{
		...
		if ($GUIImageSourceSettingRAMDISK.Checked) {
			...
			Save_Dynamic -regkey "Solutions\RAMDisk" -name "RAMDisk" -value "False" -String
			$GUIImageSourceSetting_RAMDISK_Volume_Label.Enabled = $False
			$GUIImageSource_Setting_RAMDISK_Change.Enabled = $False
			$GUIImageSource_Setting_RAMDISK_Restore.Enabled = $False
			$GUIImageSource_Setting_Abandon_Allow_Auto.Enabled = $False
	...
	Function Image_Select_Refresh_Sources_List
	{
		...
		$GoToGroup = @{
			...
			GroupPK = @(
				@{ Path = @("Menu_Shortcuts_Image_Sources_Append"); Lang = "$($lang.Sel_Primary_Key): $($lang.Wim_Append)"; }
				@{ Path = @("Menu_Shortcuts_Apply");               Lang = "$($lang.Sel_Primary_Key): $($lang.Apply)"; }
				@{ Path = @("Menu_Shortcuts_Remove");              Lang = "$($lang.Sel_Primary_Key): $($lang.Del)"; }
...
#							$GUIImageSourceGroupMountToShow.Text = "$($Global:Image_source)_Custom"
	...
	$UI_Main_Adv_Sel_ImageSources_Show_Key = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($This.Checked) {
				...
				Save_Dynamic -regkey "Solutions" -name "IsShowSelectKey" -value "False" -String
	...
	$GUIImageSource_Setting_RAMDISK_Change = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			#>
			Save_Dynamic -regkey "Solutions\RAMDisk" -name "RAMDisk_Volume_Label" -value $GUIImageSourceSetting_RAMDISK_Volume_Label.Text -String
	...
	$GUIImageSource_Setting_Abandon_Allow_Auto = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($This.Checked) {
				...
				Save_Dynamic -regkey "Solutions" -name "Abandon_Allow_Auto" -value "False" -String
			}
		}
	}
	...
	$GUIImageSource_Setting_RAMDISK_Exclude = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($This.Checked) {
				...
				Save_Dynamic -regkey "Solutions\RAMDisk" -name "RAMDisk_Exclude" -value "False" -String
	...
	$GUIImageSource_Setting_Custom_Exclude = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($This.Checked) {
				...
				Save_Dynamic -regkey "Solutions" -name "Custom_Exclude" -value "False" -String
				...
				if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions" -Name "DiskCache" -ErrorAction SilentlyContinue) {
					...
					#>
					if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions" -Name "DiskCache" -ErrorAction SilentlyContinue) {
						$CustomRAMDISKLabel = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$((Get-Module -Name Solutions).Author)\Solutions" -Name "DiskCache" -ErrorAction SilentlyContinue
	...
	$GUIImageSourceGroupSettingDefenderAdd = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($This.Checked) {
				...
				Save_Dynamic -regkey "Solutions" -name "IsDefenderExclude" -value "False" -String
