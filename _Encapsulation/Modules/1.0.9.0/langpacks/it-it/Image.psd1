ConvertFrom-StringData -StringData @'
	...
	AutoSelectRAMDISKFailed         = Etichetta del volume non corrispondente
	ReFS_Find_Volume                = Quando viene rilevato il formato disco REFS, escludere
	ReFS_Exclude                    = Partizione ReFS esclusa
	Disk_Not_satisfied_Exclude      = Requisiti minimi del disco non soddisfatti
	RAMDISK_Change                  = Modifica il nome dell'etichetta del volume
	RAMDISK_Search                  = Cerca nome etichetta volume
	...
	ImageSourcesClickShowKey        = Consenti la visualizzazione del menu "Seleziona chiave primaria"
	ImageSourcesClickShowKeyTips    = Dopo che l'utente ha selezionato la sorgente dell'immagine: aggiungi un menu "Seleziona chiave primaria" sulla destra e aggiungi le opzioni "Vai a": Monta, Salva, Pop-up.
	...
	Image_Unmount_After             = Disinstalla tutto montato
	...
	Wim_Rule_CheckIntegrity         = Verifica integrità
	Wim_Rule_ReadOnly               = Autorizzazione di sola lettura
	Wim_Rule_Optimize               = Ottimizzazione
	Wim_Rule_SupportEa              = Applica immagini con attributi estesi
	Wim_Rule_WIMBoot                = Avviabile
	Wim_Rule_Compact                = Comprimi file del sistema operativo
	Win_Rule_Setbootable            = Contrassegna immagine volume come avviabile
	Win_Rule_Setbootable_Tips       = Questo parametro si applica solo alle immagini Windows PE.\nÈ possibile contrassegnare come avviabile una sola immagine volume in un file .wim.
	Destination                     = Destinazione

	Wim_Append                      = Aggiungi
	Wim_Capture                     = Acquisisci
	Wim_Capture_Tips                = Acquisisci l'immagine dell'unità in un nuovo file WIM.
	Wim_Capture_Sources             = Sorgente di acquisizione
	Wim_Capture_Sources_Tips        = La directory acquisita contiene tutte le sottocartelle e i dati.\nNon è possibile acquisire una directory vuota. La directory deve contenere almeno un file.
	Wim_Config_File                 = Percorso file di configurazione ( esclusioni )
	Wim_Config_Edit                 = Modifica
	Wim_Config_Learn                = Esamina l'elenco di configurazione e il file WimScript.ini
	...
	Wim_CreatedTime                 = Data di creazione
	Wim_ModifiedTime                = Ultima modifica
	Wim_FileCount                   = Numero di file
	Wim_DirectoryCount              = Numero di directory
	...
	DefenderExclude                 = Esclusioni Antivirus di Windows
	DefenderFolder                  = Aggiungi questa directory alle Esclusioni Antivirus di Windows.
	DefenderVolume                  = Dopo aver trovato un nome etichetta volume corrispondente, aggiungi questo disco alle Esclusioni Antivirus di Windows.
	DefenderIsAdd                   = Aggiunto alle Esclusioni Antivirus di Windows
'@