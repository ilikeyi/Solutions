ConvertFrom-StringData -StringData @'
	...
	SaveModeTipsClear               = L'historique a été sauvegardé et peut être effacé
	SelectTips                      = Indice\n\n    1. Veuillez sélectionner le nom de l'image à traiter;\n    2. Après l'annulation, les tâches qui nécessitent un "montage" avant l'opération ne prendront plus effet.
	CacheDisk                       = Cache de disque
	...
	AutoSelectRAMDISKFailed         = Le libellé du volume ne correspond pas
	ReFS_Find_Volume                = Lorsque le format de disque REFS est rencontré, excluez
	ReFS_Exclude                    = Partition ReFS exclue
	Disk_Not_satisfied_Exclude      = Configuration minimale requise pour le disque dur non respectée
	RAMDISK_Change                  = Changer le nom du volume
	RAMDISK_Search                  = Trouver le nom du volume
	RAMDISK_Restore                 = Restaurer le nom du volume initialisé: {0}
	AllowTopMost                    = Permettre aux fenêtres ouvertes d'être épinglées en haut
	...
	HistoryLog                      = Autoriser le nettoyage automatique des journaux de plus de 7 jours
	...
	DoNotCheckBoot                  = Boot.wim Une fois que la taille du fichier dépasse 520 Mo, la reconstruction est automatiquement vérifiée lors de la génération de ISO.
	HistoryClearDismSave            = Supprimer les enregistrements de montage DISM enregistrés dans le registre
	ImageSourcesClickShowKey        = Afficher le menu "Sélectionner la clé principale"
	ImageSourcesClickShowKeyTips    = Après la sélection de la source de l'image par l'utilisateur: ajouter un menu "Sélectionner la clé principale" à droite, avec les options "Accéder à": Monter, Enregistrer, Ouvrir dans une fenêtre contextuelle.
	...
	SettingImageToTemp              = Le répertoire temporaire est le même que l'endroit où il a été monté.
	...
	SettingImageNewPathTips         = Il est recommandé de le monter sur un disque mémoire, qui est le plus rapide.
	...
	ArchitecturePack                = Architecture du paquet, compréhension de l'ajout de règles
	...
	Image_Restore_Default           = Retourner aux paramètres par défaut
	Image_Popup_Tips                = Indice:\n\nLorsque vous avez attribué l'événement, vous n'avez pas spécifié le numéro d'index à traiter {0};\n\nL'interface de sélection est actuellement apparue.
	Rule_Show_Full                  = Afficher tout
	Rule_Show_Only                  = Afficher seulement les règles
	Rule_Show_Only_Select           = Choisissez parmi les règles
	Image_Unmount_After             = Désinstaller tous les montages
	...
	Wim_Rule_CheckIntegrity         = Vérifier l'intégrité
	Wim_Rule_ReadOnly               = Autorisation de lecture seule
	Wim_Rule_Optimize               = Optimisation
	Wim_Rule_SupportEa              = Appliquer des images avec des attributs étendus
	Wim_Rule_WIMBoot                = Amorçable
	Wim_Rule_Compact                = Compresser les fichiers du système d'exploitation
	Win_Rule_Setbootable            = Marquer l'image volume comme amorçable
	Win_Rule_Setbootable_Tips       = Ce paramètre s'applique uniquement aux images Windows PE.\nUne seule image volume peut être marquée comme amorçable dans un fichier .wim.
	Destination                     = Destination

	Wim_Append                      = Ajouter
	Wim_Capture                     = Capture
	Wim_Capture_Tips                = Capturez l'image du disque dans un nouveau fichier WIM.
	Wim_Capture_Sources             = Source de la capture
	Wim_Capture_Sources_Tips        = Le répertoire capturé contient tous les sous-répertoires et les données.\nVous ne pouvez pas saisir un répertoire vide. Le répertoire doit contenir au moins un fichier.
	Wim_Config_File                 = Chemin du fichier de configuration ( Exclusions )
	Wim_Config_Edit                 = Modifier
	Wim_Config_Learn                = Consultez la liste de configuration et le fichier WimScript.ini

	Wim_Rename                      = Modifier les renseignements de l'image
	...
	Wim_CreatedTime                 = Date de création
	Wim_ModifiedTime                = Dernière modification
	Wim_FileCount                   = Nombre de fichiers
	Wim_DirectoryCount              = Nombre de répertoires
	...
	ShowAllExclude                  = Afficher toutes les exclusions désuètes
	...
	DefenderExclude                 = Exclusions de l'antivirus Windows
	DefenderFolder                  = Ajouter ce répertoire aux exclusions de l'Antivirus Windows.
	DefenderVolume                  = Après avoir trouvé un nom de volume correspondant, ajoutez ce disque aux exclusions de l'Antivirus Windows.
	DefenderIsAdd                   = Ajouté aux exclusions de l'Antivirus Windows
'@