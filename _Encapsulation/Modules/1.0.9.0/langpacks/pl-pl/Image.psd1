ConvertFrom-StringData -StringData @'
	...
	AutoSelectRAMDISKFailed         = Nie dopasowana etykieta woluminu
	ReFS_Find_Volume                = W przypadku napotkania formatu dysku REFS wyklucz
	ReFS_Exclude                    = Partycja ReFS wykluczona
	Disk_Not_satisfied_Exclude      = Minimalne wymagania dotyczące dysku nie zostały spełnione
	RAMDISK_Change                  = Zmień nazwę etykiety woluminu
	RAMDISK_Search                  = Wyszukaj nazwę etykiety woluminu
	...
	ImageSourcesClickShowKey        = Zezwól na wyświetlanie menu "Wybierz klucz podstawowy"
	ImageSourcesClickShowKeyTips    = Po wybraniu przez użytkownika źródła obrazu: Dodaj menu "Wybierz klucz podstawowy" po prawej stronie i dodaj opcje "Przejdź do": Montuj, Zapisz, Wyskakujące okienko.
	...
	Wim_Rule_CheckIntegrity         = Sprawdź integralność
	Wim_Rule_ReadOnly               = Uprawnienia tylko do odczytu
	Wim_Rule_Optimize               = Optymalizacja
	Wim_Rule_SupportEa              = Zastosuj obrazy z rozszerzonymi atrybutami
	Wim_Rule_WIMBoot                = Rozruchowy
	Wim_Rule_Compact                = Kompresja plików systemu operacyjnego
	Win_Rule_Setbootable            = Oznacz obraz woluminu jako rozruchowy
	Win_Rule_Setbootable_Tips       = Ten parametr dotyczy tylko obrazów Windows PE.\nW pliku .wim można oznaczyć tylko jeden obraz woluminu jako rozruchowy.
	Destination                     = Miejsce docelowe

	Wim_Append                      = Dołącz
	Wim_Capture                     = Przechwyć
	Wim_Capture_Tips                = Przechwyć obraz dysku do nowego pliku WIM.
	Wim_Capture_Sources             = Źródło przechwytywania
	Wim_Capture_Sources_Tips        = Przechwycony katalog zawiera wszystkie podfoldery i dane.\nNie można przechwycić pustego katalogu. Katalog musi zawierać co najmniej jeden plik.
	Wim_Config_File                 = Ścieżka do pliku konfiguracyjnego ( wykluczenia )
	Wim_Config_Edit                 = Edytuj
	Wim_Config_Learn                = Przejrzyj listę konfiguracji i plik WimScript.ini
	...
	Wim_CreatedTime                 = Data utworzenia
	Wim_ModifiedTime                = Czas ostatniej modyfikacji
	Wim_FileCount                   = Liczba plików
	Wim_DirectoryCount              = Liczba katalogów
	...
	DefenderExclude                 = Wykluczenia w oprogramowaniu antywirusowym systemu Windows
	DefenderFolder                  = Dodaj ten katalog do wykluczeń w oprogramowaniu \nantywirusowym systemu Windows.
	DefenderVolume                  = Po znalezieniu pasującej nazwy etykiety woluminu dodaj ten dysk\ndo wykluczeń w oprogramowaniu antywirusowym systemu Windows.
	DefenderIsAdd                   = Dodano do wykluczeń w oprogramowaniu antywirusowym systemu Windows
'@