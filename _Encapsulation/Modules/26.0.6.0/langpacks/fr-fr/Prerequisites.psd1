ConvertFrom-StringData -StringData @'
	...
	LowAndCurrentError              = Version minimale: {0}, version actuelle: {1}
	Check_Eligible                  = Admissible
	Check_Version_PSM_Error         = Erreur de version, veuillez vous référer à {0}.psm1.Example, remettez à niveau {0}.psm1 et réessayez.

	Check_OSEnv                     = Vérification de l'environnement du système
	Check_Image_Bad                 = Vérifiez si l'image chargée est corrompue
	Check_Need_Fix                  = Objets cassés qui doivent être réparés
	Image_Mount_Mode                = Mode de montage
	Image_Mount_Status              = État du montage
	Check_Compatibility             = Vérification de compatibilité
