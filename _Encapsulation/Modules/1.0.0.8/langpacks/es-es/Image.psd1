ConvertFrom-StringData -StringData @'
	...
	AutoSelectRAMDISKFailed         = La etiqueta de volumen no coincide: {0}
	...
	SettingImagePathTemp            = Usando el directorio temporal
	...
	MountedIndexSuccess             = Montado, por medios legales
	MountedIndexError               = Montaje anormal, elimínelo e inténtelo nuevamente.
	...
	Image_Unmount_After             = Desmontar con fuerza todas las imágenes montadas
	...
	Wim_Created                     = Fecha de creación
	Wim_Expander_Space              = Espacio de expansión

	IABSelectNo                     = No se seleccionó ninguna clave principal: Instalar, WinRE, Arrancar
