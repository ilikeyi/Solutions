ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Korte zonemarkering
	LanguageRegionLink              = Regionale vereniging
	LanguageNoSelect                = Toon bekende talen na het selecteren van de afbeeldingsbron
	...
	LanguageExtractSearchResult     = Zoekresultaten
	LanguageExtractSearchResultNO   = Geen overeenkomende resultaten
	LanguageExtractSearchResultTips = Selecteer de taal, klik op de knop 'Zoeken en matchen' en controleer of de taalinhoud die u wilt toevoegen consistent is. Als dat het geval is, klikt u op de knop 'Importeren' om direct resultaten weer te geven.
	LanguageExtractSearch           = Zoek en match
	LanguageExtractAddTo            = Importeren
	LanguageExtractTo               = Voeg na het importeren toe aan:
'@