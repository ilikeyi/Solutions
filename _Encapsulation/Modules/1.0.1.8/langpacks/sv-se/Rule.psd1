ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Kort zonmarkering
	LanguageRegionLink              = Regionförbund
	LanguageNoSelect                = Visa kända språk efter att ha valt bildkälla
	...
	LanguageExtractSearchResult     = Sökresultat
	LanguageExtractSearchResultNO   = Inga matchande resultat
	LanguageExtractSearchResultTips = Välj språk, klicka på knappen "Sök och matcha" och kontrollera om språkinnehållet du vill lägga till är konsekvent. Klicka i så fall på knappen "Importera" för att visa omedelbara resultat.
	LanguageExtractSearch           = Sök och matcha
	LanguageExtractAddTo            = Importera
	LanguageExtractTo               = Efter import lägg till:
'@