ConvertFrom-StringData -StringData @'
	...
	Other_Tasks_Clear               = Fjern alle genererte
	Other_Tasks_Empty               = Tom oppgave
	Other_Tasks_Pause               = Pause
	Other_Tasks_RAMDISK             = Søk på alle lokale diskvolumer med RADMDISK og formater dem
	Other_Tasks_RAMDISK_AR          = Søk på alle lokale diskvolumer med RADMDISK og formater + reparer dem automatisk
	Other_Tasks_REFS                = WinPE legger til REFS installasjonsstøtte
	Other_Tasks_TPM                 = Omgå TPM installasjonssjekk
'@