...
<#
	.快捷指令，追加 + 主键
#>
Function Menu_Shortcuts_Image_Sources_Append_IAB
{
	param
	(
		$Command
...
<#
	.开发者模式：启用、禁用
#>
Function Menu_Shortcuts_Developers_Mode
{
...
<#
	.快捷指令：PS *
#>
Function Menu_Shortcuts_PS_Cmd
{
	param
	(
		$Command
...
<#
	.快捷指令，附加版本
#>
Function Menu_Shortcuts_Additional_Edition
{
	param
	(
		$Command
...
<#
	.快捷指令，附加版本 + 主键
#>
Function Menu_Shortcuts_Additional_Edition_Key
{
	param
	(
		$Command
