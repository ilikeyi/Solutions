		...
		add_Click      = {
			...
			if ($FolderBrowser.ShowDialog() -eq "OK") {
				if (Test_Available_Disk -Path $FolderBrowser.SelectedPath) {
					...
					$UI_Main_Apply_Detailed_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
		...
		add_Click      = {
			...
			if ([string]::IsNullOrEmpty($GUIImageSourceISOCustomizePath.Text)) {
				...
				if (Test-Path -Path $GUIImageSourceISOCustomizePath.Text -PathType Container) {
					...
					$UI_Main_Apply_Detailed_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
