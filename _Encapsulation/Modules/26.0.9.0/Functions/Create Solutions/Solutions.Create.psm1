...
$SearchKMS = @(
	...
	@{ Type = "Desktop"; ProductKey = "W269N-WFGWX-YVC9B-4J6C9-T83GX"; Name = "Windows 10 and 11 Professional"; }
	@{ Type = "Desktop"; ProductKey = "MH37W-N47XK-V7XM9-C7227-GCQG9"; Name = "Windows 10 and 11 Professional N"; }
	@{ Type = "Desktop"; ProductKey = "NRG8B-VKK3Q-CXVCJ-9G2XF-6Q84J"; Name = "Windows 10 and 11 Pro for Workstations"; }
	@{ Type = "Desktop"; ProductKey = "9FNHH-K3HBT-3W4TD-6383H-6XYWF"; Name = "Windows 10 and 11 Pro for Workstations N"; }
	@{ Type = "Desktop"; ProductKey = "6TP4R-GNPTD-KYYHQ-7B7DP-J447Y"; Name = "Windows 10 and 11 Pro Education"; }
	@{ Type = "Desktop"; ProductKey = "YVWGF-BXNMC-HTQYQ-CPQ99-66QFC"; Name = "Windows 10 and 11 Pro Education N"; }
	@{ Type = "Desktop"; ProductKey = "NW6C2-QMPVW-D7KKK-3GKT6-VCFB2"; Name = "Windows 10 and 11 Education"; }
	@{ Type = "Desktop"; ProductKey = "2WH4N-8QGBV-H22JP-CT43Q-MDWWJ"; Name = "Windows 10 and 11 Education N"; }
	@{ Type = "Desktop"; ProductKey = "NPPR9-FWDCX-D2C8J-H872K-2YT43"; Name = "Windows 10 and 11 Enterprise"; }
	@{ Type = "Desktop"; ProductKey = "DPH2V-TTNVB-4X9Q3-TJR4H-KHJW4"; Name = "Windows 10 and 11 Enterprise N"; }
	@{ Type = "Desktop"; ProductKey = "YYVX9-NTFWV-6MDM3-9PT4T-4M68B"; Name = "Windows 10 and 11 Enterprise G"; }
	@{ Type = "Desktop"; ProductKey = "44RPN-FTY23-9VTTB-MP9BX-T84FV"; Name = "Windows 10 and 11 Enterprise G N"; }
	@{ Type = "Desktop"; ProductKey = "M7XTQ-FN8P6-TTKYV-9D4CC-J462D"; Name = "Windows 10 and 11 Enterprise LTSC ( 2024, 2021, 2021 )"; }
	@{ Type = "Desktop"; ProductKey = "92NFX-8DJQP-P6BBQ-THF9C-7CG2H"; Name = "Windows 10 and 11 Enterprise N LTSC ( 2024, 2021, 2021 )"; }
	@{ Type = "Desktop"; ProductKey = "KBN8V-HFGQ4-MGXVD-347P6-PDQGT"; Name = "Windows IoT Enterprise LTSC ( 2024, 2021 )"; }
	...
	@{ Type = "Desktop"; ProductKey = "WNMTR-4C88C-JK8YV-HQ7T2-76DF9"; Name = "Windows 10 Enterprise LTSB 2015"; }
	@{ Type = "Desktop"; ProductKey = "2F77B-TNFGY-69QQF-B8YKP-D69TJ"; Name = "Windows 10 Enterprise N LTSB 2015"; }
	...
	@{ Type = "Server";  ProductKey = "XGN3F-F394H-FD2MY-PP6FD-8MCRC"; Name = "Windows Server 2025 Datacenter: Azure Edition"; }
	...
	@{ Type = "Server";  ProductKey = "NTBV8-9K7Q8-V27C6-M2BTV-KHMXV"; Name = "Windows Server 2022 Datacenter: Azure Edition"; }
)
...
Function Solutions_Create_UI
{
	...
	Function Solutions_Create_Refresh_Regional
	{
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Region_Preferred" -ErrorAction SilentlyContinue) {
			$GetNewSaveLanguage = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Region_Preferred" -ErrorAction SilentlyContinue
	...
	Function Save_User_Select_Command_To_Regedit
	{
		...
		<#
			.保存到注册表
		#>
		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Save_Command_WinSetup" -value $Temp_Save_Windows_Setup -Type "MultiString"
		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Save_Command_WinSPE" -value $Temp_Save_Windows_PE -Type "MultiString"
	}
	...
	Function Solutions_Create_Refresh_Software_List
	{
		...
		if (-not (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -Name "$($Script:init_To_GPS)_Exclude_Software" -ErrorAction SilentlyContinue)) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -name "$($Script:init_To_GPS)_Exclude_Software" -value "" -Type "MultiString"
		}
		$GetExcludeSoftware = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -Name "$($Script:init_To_GPS)_Exclude_Software" -ErrorAction SilentlyContinue
		...
		if (-not (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -Name "$($Script:init_To_GPS)_Exclude_Fonts" -ErrorAction SilentlyContinue)) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -name "$($Script:init_To_GPS)_Exclude_Fonts" -value "" -Type "MultiString"
		}
		$GetExcludeFonts = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -Name "$($Script:init_To_GPS)_Exclude_Fonts" -ErrorAction SilentlyContinue
		...
		Get-ChildItem "$($PSScriptRoot)\..\..\..\..\_Custom\Software" -directory -ErrorAction SilentlyContinue | ForEach-Object {
			...
			Get-ChildItem $_.FullName -directory -ErrorAction SilentlyContinue | ForEach-Object {
				$NewFolderPath = $_.BaseName
				$NewGroupName = New-Object system.Windows.Forms.Label -Property @{
					Height         = 35
					Width          = 412
					Text           = $NewFolderPath
				}
				$GroupSoftwareList.controls.AddRange($NewGroupName)
				...
				Get-ChildItem $_.FullName -directory -ErrorAction SilentlyContinue | ForEach-Object {
					$CheckBox   = New-Object System.Windows.Forms.CheckBox -Property @{
						...
						Padding = "36,0,0,0"
						Text    = $_.BaseName
						Tag     = "$($Mark_Main_Folder)\$($NewFolderPath)\$($_.BaseName)"
						add_Click      = {
							$UI_Main_Error.Text = ""
							$UI_Main_Error_Icon.Image = $null
						}
					...
					$NewGroupName_Add_End_Wrap = New-Object system.Windows.Forms.Label -Property @{
						Height         = 30
						Width          = 425
					}
					$GroupSoftwareList.controls.AddRange((
						$CheckBox,
						$NewGroupName_Add_End_Wrap
					))
				}
			}
		}
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_PreOfficeVersion" -ErrorAction SilentlyContinue) {
			$GetTempSelectPacker = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_PreOfficeVersion" -ErrorAction SilentlyContinue
	...
	Function Solutions_Create_Refresh_Office_Status
	{
		...
		if ($ArchitectureARM64.Checked) {
			Get-ChildItem -Path "$($PSScriptRoot)\..\..\..\..\_Custom\Office" -directory -ErrorAction SilentlyContinue | ForEach-Object {
				...
				$NewFolderFullPath = "$($NewFolderPath)\arm64\Office\Data\v64.cab"
...
"@ | Out-File -FilePath $SaveFileTo -Encoding Ascii -ErrorAction SilentlyContinue
		...
		if ($SchemeDiskHalf.Checked) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_UnattendMode" -value "1"
		...
		if ($SchemeDiskUefi.Checked) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_UnattendMode" -value "2"
		...
		if ($SchemeDiskLegacy.Checked) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_UnattendMode" -value "3"
			$SchemeDiskSpecifiedPanel.Enabled = $True
			$SchemeVerMulti.Enabled = $True
			$SchemeVerSingle.Enabled = $True
		}
	...
	$CreateUnattendISOClick = {
		...
		if ($CreateUnattendISO.Checked) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendISO" -value "True"
		} else {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendISO" -value "False"
		}

		if ($CreateUnattendISOSources.Checked) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendISOSources" -value "True"
		} else {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendISOSources" -value "False"
		}

		if ($CreateUnattendISOSourcesOEM.Checked) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendISOSourcesOEM" -value "True"
		} else {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendISOSourcesOEM" -value "False"
		}

		if ($CreateUnattendPanther.Checked) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendPather" -value "True"
		} else {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_AllowUnattendPather" -value "False"
		}
	}
	...
	$SchemeVerMultiClick = {
		...
		if ($SchemeVerMulti.Checked) {
			$SchemeVerSingle.Enabled = $False
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsLanguageUnattend" -value "True"
		} else {
			$SchemeVerSingle.Enabled = $True
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsLanguageUnattend" -value "False"
		}

		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_LanguageUnattend" -value $SchemeVerSingle.Text
	}
	...
	$SchemeLangMultiClick = {
		...
		if ($SchemeLangMulti.Checked) {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsLanguageCollection" -value "True"
		} else {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsLanguageCollection" -value "False"
		}

		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_LanguageCollection" -value $SchemeLangSingle.Text
	}
	...
	Function Solutions_Create_Refresh_Collection_Language
	{
		...
		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -name "$($Script:init_To_GPS)_Collection_Reserved_Language" -value $Temp_DeployCollectionLanguageOnly -Type "MultiString"
	...
	Function Solutions_Create_Refresh_Office_Language
	{
		...
		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -name "$($Script:init_To_GPS)_Reserved_Language" -value $TempDeployOfficeLanguageOnly -Type "MultiString"
	...
	Function Refresh_Command_Rule_Select_Group
	{
		...
		<#
			.Windows 安装初始化选择
		#>
		if (-not (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Save_Command_WinSetup" -ErrorAction SilentlyContinue)) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Save_Command_WinSetup" -value $Script:Init_Pre_Select_Command -Type "MultiString"
		}
		$Get_Init_Select_Guid_Command = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Save_Command_WinSetup" -ErrorAction SilentlyContinue
		...
		<#
			.Windows PE
		#>
		if (-not (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Save_Command_WinSPE" -ErrorAction SilentlyContinue)) {
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Save_Command_WinSPE" -value "" -Type "MultiString"
		}
		$Get_Init_Select_Guid_PE_Command = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Save_Command_WinSPE" -ErrorAction SilentlyContinue
	...
	Function Autopilot_Solutions_Save
	{
		...
		if ($MarkolutionsCustomizeName) {
			<#
				...
				.处理: 完成后
			#>
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_SaveEngine" -value $GUISolutionsCustomizeName.Text
		}
		...
		if ($InstlModebusiness.Enabled) {
			...
			if ($SolutionsSoftwarePacker.Checked) {
						...
						if ($_ -is [System.Windows.Forms.RadioButton]) {
							if ($_.Enabled) {
								if ($_.Checked) {
									...
									Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -name "SolutionsPacker_$($Script:init_To_GPS)" -value $_.Text
								}
							}
						}
					}
				...
				if ($GroupSoftwareListTitle.Checked) {
					if ($SoftwarePackageToRoot.Checked) {
						New-Variable -Scope global -Name "DeploySoftwareTo_$($Script:init_To_GPS)" -Value "1" -Force
					}

					if ($SoftwarePackageToSolutions.Checked) {
						New-Variable -Scope global -Name "DeploySoftwareTo_$($Script:init_To_GPS)" -Value "2" -Force
					}

					if ($SoftwarePackageToPublish.Checked) {
						New-Variable -Scope global -Name "DeploySoftwareTo_$($Script:init_To_GPS)" -Value "3" -Force
					}
					...
					$GroupSoftwareList.Controls | ForEach-Object {
						if ($_ -is [System.Windows.Forms.Checkbox]) {
							if ($_.Enabled) {
								if ($_.Checked) {
									$Temp_QueueSoftwareSelect += [pscustomobject]@{
										Name = $_.Text;
										Path = $_.Tag
									}
								} else {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -name "$($Script:init_To_GPS)_Exclude_Software" -value $Temp_QueueSoftwareNoSelect -Type "MultiString"
					}
				} else {
					New-Variable -Scope global -Name "QueueSoftwareSelect_$($Script:init_To_GPS)" -Value @() -Force
					New-Variable -Scope global -Name "QueueSoftwareNoSelect_$($Script:init_To_GPS)" -Value @() -Force
				...
				if ($GroupFontsListTitle.Checked) {
					...
					$GroupFontsList.Controls | ForEach-Object {
						if ($_ -is [System.Windows.Forms.Checkbox]) {
							if ($_.Enabled) {
								if ($_.Checked) {
									$Temp_QueueFontsSelect += [pscustomobject]@{
										Name = $_.Text;
										Path = $_.Tag
									}
								} else {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -name "$($Script:init_To_GPS)_Exclude_Fonts" -value $Temp_QueueFontsNoSelect -Type "MultiString"
					}
				} else {
					New-Variable -Scope global -Name "QueueFontsSelect_$($Script:init_To_GPS)" -Value @() -Force
					New-Variable -Scope global -Name "QueueFontsNoSelect_$($Script:init_To_GPS)" -Value @() -Force
		...
		if ($SolutionsUnattend.Checked) {
			...
			if ([string]::IsNullOrEmpty($Unattend_Version_Select.Text)) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_Scheme" -value $Unattend_Version_Select.Text -Type "MultiString"
			...
			if ($GUISolutionsVerifySync.Enabled) {
				if ($GUISolutionsVerifySync.Checked) {
					Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_OSAccountName" -value 1
				} else {
					Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_OSAccountName" -value 2
				}
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_OSAccountName" -value 2
			}
...
#							KMSkeys
		...
		if ($SolutionsEngine.Checked) {
			if ([string]::IsNullOrEmpty($GroupMainVerList.Text)) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_SelectSolutionVersion" -value $GroupMainVerList.Text

				<#
					.允许全盘搜索并同步部署标记
				#>
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Is_Mark_Sync" -value "False"
				if ($EngineChkSyncMark.Enabled) {
					if ($EngineChkSyncMark.Checked) {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Is_Mark_Sync" -value "True"
				...
				if ($EngineDefender.Enabled) {
					if ($EngineDefender.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Defender" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Defender" -value "False"
					}
				}
				...
				if ($EngineNetworkLocationWizard.Enabled) {
					if ($EngineNetworkLocationWizard.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Network_Location_Wizard" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Network_Location_Wizard" -value "False"
					}
				}
				...
				if ($GUISolutionsVolume.Enabled) {
					if ($GUISolutionsVolume.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Sync_Volume_Name" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Sync_Volume_Name" -value "False"
					}
				}
				...
				if ($GUIPreAppxCleanup.Enabled) {
					if ($GUIPreAppxCleanup.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_PreAppxCleanup" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_PreAppxCleanup" -value "False"
					}
				}
				...
				if ($GUILanguageComponents.Enabled) {
					if ($GUILanguageComponents.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_LanguageComponents" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_LanguageComponents" -value "False"
					}
				}
				...
				if ($GUIPreventCleaningUnusedLP.Enabled) {
					if ($GUIPreventCleaningUnusedLP.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_PreventCleaningUnusedLP" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_PreventCleaningUnusedLP" -value "False"
					}
				}
				...
				if ($EngineDeskMenu.Enabled) {
					if ($EngineDeskMenu.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Desktop_Menu" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Desktop_Menu" -value "False"
					}
				}
				if ($EngineDeskMenuShift.Enabled) {
					if ($EngineDeskMenuShift.Checked) {
						$QueueDeploySelect += "Desktop_Menu_Shift"
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Desktop_Menu_Shift" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Desktop_Menu_Shift" -value "False"
					}
				}
				...
				if ($EnginePrerequisitesReboot.Enabled) {
					if ($EnginePrerequisitesReboot.Checked) {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Prerequisites_Reboot" -value "True"
						$QueueDeploySelect += "Prerequisites_Reboot"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Prerequisites_Reboot" -value "False"
					}
				} else {
					Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Prerequisites_Reboot" -value "False"
				}
				...
				if ($EnginePopsupEngine.Enabled) {
					if ($EnginePopsupEngine.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_PopupEngine" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_PopupEngine" -value "False"
					}
				}
				...
				if ($EngineFirstExp.Enabled) {
					if ($EngineFirstExp.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Allow_First_Pre_Experience" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Allow_First_Pre_Experience" -value "False"
					}
				}
				...
				if ($EngineRestricted.Enabled) {
					if ($EngineRestricted.Checked) {
						...
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Restricted" -value "True"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Restricted" -value "False"
					}
				}
				...
				if ($EngineDoneClearFull.Enabled) {
					if ($EngineDoneClearFull.Checked) {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_ClearFull" -value "True"
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Clear" -value "False"
						$QueueDeploySelect += "Clear_Solutions"
						$QueueDeploySelect += "Clear_Engine"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_ClearFull" -value "False"
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Clear" -value "False"
					}
				} else {
					Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_ClearFull" -value "False"
				...
				if ($EngineDoneClear.Enabled) {
					if ($EngineDoneClear.Checked) {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Clear" -value "True"
						$QueueDeploySelect += "Clear_Engine"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Clear" -value "False"
					}
				...
				if ($FirstExpFinishReboot.Enabled) {
					if ($FirstExpFinishReboot.Checked) {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_First_Experience_Reboot" -value "True"
						$QueueDeploySelect += "First_Experience_Reboot"
					} else {
						Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_First_Experience_Reboot" -value "False"
					}
				} else {
					Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_First_Experience_Reboot" -value "False"
				}
	...
	$GUISolutionsShowLanguageUTF8 = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($GUISolutionsShowLanguageUTF8.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Region_UTF8" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Region_UTF8" -value "False"
			}
		}
	}
	...
	$GUISolutionsRegional_Hide_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\Assets\icon\hide.png")
	...
	$ArchitectureARM64 = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			$SoftwareTipsErrorMsg.Text = $lang.SolutionsTipsArm64
			Solutions_Create_Refresh_Office_Status
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_SolutionsSoftwareArch" -value "arm64"
		}
	}
	$ArchitectureAMD64 = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			$SoftwareTipsErrorMsg.Text = $lang.SolutionsTipsAMD64
			Solutions_Create_Refresh_Office_Status
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_SolutionsSoftwareArch" -value "amd64"
		}
	}
	$ArchitectureX86    = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			$SoftwareTipsErrorMsg.Text = $lang.SolutionsTipsX86
			Solutions_Create_Refresh_Office_Status
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_SolutionsSoftwareArch" -value "x86"
		}
	}
	...
	$GUISolutionsCollectionLangGet = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -name "$($Script:init_To_GPS)_Collection_Reserved_Language" -value $Verify_Language_New_Path.Lang -Type "MultiString"
			...
			$GUISolutionsCollectionChange_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\Assets\icon\Success.png")
		}
	}
	...
	$SolutionsOfficeOnly = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($this.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -name "$($Script:init_To_GPS)_AllowSyncConfig" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -name "$($Script:init_To_GPS)_AllowSyncConfig" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_AllowSyncConfig" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_AllowSyncConfig" -ErrorAction SilentlyContinue) {
			"True" {
	...
	$GUISolutionsOfficeLangGet = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -name "$($Script:init_To_GPS)_Reserved_Language" -value $Verify_Language_New_Path.Lang -Type "MultiString"
			$SolutionsOfficeKeepShow.Text = $Verify_Language_New_Path.Lang

			$GUISolutionsOfficeChange_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\Assets\icon\Success.png")
	...
	$GUISolutionsOfficeToPublic = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -name "$($Script:init_To_GPS)_CopyTo" -value 1
		}
	}
	...
	$GUISolutionsOfficeToMain = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -name "$($Script:init_To_GPS)_CopyTo" -value 2
		}
	}
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_Reserved_Language" -ErrorAction SilentlyContinue) {
		$SolutionsOfficeKeepShow.Text = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_Reserved_Language" -ErrorAction SilentlyContinue
	} else {
		$Verify_Language_New_Path = ISO_Local_Language_Calc
		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -name "$($Script:init_To_GPS)_Reserved_Language" -value $Verify_Language_New_Path.Lang -Type "MultiString"
		$SolutionsOfficeKeepShow.Text = $Verify_Language_New_Path.Lang
	...
	$SolutionsPackage  = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SolutionsPackage.Checked) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -name "$($Script:init_To_GPS)_AllowDeployCollection" -value "True"
			} else {
				$SolutionsPackageShow.Enabled = $False
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -name "$($Script:init_To_GPS)_AllowDeployCollection" -value "False"
			}
		}
	}
	...
	$SolutionsPackageToRoot = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		Width          = 418
		Padding        = "18,0,0,0"
		Text           = $lang.DeployToRoot
		Checked        = $True
		add_Click      = {
			$UI_Main_Error.Text = ""
			$UI_Main_Error_Icon.Image = $null

			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -name "$($Script:init_To_GPS)_DeployCollectionSelect" -value "1"
		}
	}
	$SolutionsPackageToSolutions = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -name "$($Script:init_To_GPS)_DeployCollectionSelect" -value "2"
		}
	}
	$SolutionsPackageToPublish = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -name "$($Script:init_To_GPS)_DeployCollectionSelect" -value "3"
		}
	}
	...
	$GroupSoftwareListTitle = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($GroupSoftwareListTitle.Checked) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsSoftware" -value "True"
			} else {
				$GroupSoftwareList.Enabled = $False
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsSoftware" -value "False"
			}
		}
	}
	<#
		.部署自定义合集包: 部署到
	#>
	$SoftwarePackageTo = New-Object System.Windows.Forms.Label -Property @{
		Height         = 30
		Width          = 418
		Padding        = "15,0,0,0"
		Text           = $lang.DeployPackageTo
	}
	$SoftwarePackageToRoot = New-Object System.Windows.Forms.RadioButton -Property @{
		Height         = 30
		Width          = 418
		Padding        = "33,0,0,0"
		Text           = $lang.DeployToRoot
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Software" -name "$($Script:init_To_GPS)_DeploySoftwareSelect" -value "1"
		}
	}
	$SoftwarePackageToSolutions = New-Object System.Windows.Forms.RadioButton -Property @{
		Height         = 30
		Width          = 418
		Padding        = "33,0,0,0"
		Text           = $lang.DeployPackageToSolutions
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Software" -name "$($Script:init_To_GPS)_DeploySoftwareSelect" -value "2"
		}
	}
	$SoftwarePackageToPublish = New-Object System.Windows.Forms.RadioButton -Property @{
		Height         = 30
		Width          = 418
		Padding        = "33,0,0,0"
		Text           = $lang.SolutionsDeployOfficeToPublic
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Software" -name "$($Script:init_To_GPS)_DeploySoftwareSelect" -value "3"
		}
	}
	...
	$GroupFontsListTitle = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($GroupFontsListTitle.Checked) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsFonts" -value "True"
			} else {
				$GroupFontsList.Enabled = $False
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_IsFonts" -value "False"
			}
		}
	}
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_Scheme" -ErrorAction SilentlyContinue) {
		$GetSaveEngine = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_Scheme" -ErrorAction SilentlyContinue
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\MVS" -Name "Kernel" -ErrorAction SilentlyContinue) {
			$GetSaveEngine = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\MVS" -Name "Kernel" -ErrorAction SilentlyContinue
	...
	$SolutionsOther_Custom = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			if ($this.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -name "$($Script:init_To_GPS)_OOBE_Select_Init_User" -value "Custom"
			}
	...
	$SolutionsOther_Specified = New-Object System.Windows.Forms.RadioButton -Property @{
		...
		add_Click      = {
			if ($this.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -name "$($Script:init_To_GPS)_OOBE_Select_Init_User" -value "Specified"
			}
	...
	$GUISolutionsVerifySync = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($this.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -name "$($Script:init_To_GPS)_Is_Sync_Folder_Name" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -name "$($Script:init_To_GPS)_Is_Sync_Folder_Name" -value "False"
			}

			Refresh_Select_OOBE_Init_User
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -Name "$($Script:init_To_GPS)_Is_Sync_Folder_Name" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -Name "$($Script:init_To_GPS)_Is_Sync_Folder_Name" -ErrorAction SilentlyContinue) {
			"True" {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_OSAccountName" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_OSAccountName" -ErrorAction SilentlyContinue) {
	...
	$SolutionsOther_Specified_Expand_UserName_Autorun = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($this.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -name "$($Script:init_To_GPS)_Is_Autorun" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -name "$($Script:init_To_GPS)_Is_Autorun" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -Name "$($Script:init_To_GPS)_Is_Autorun" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -Name "$($Script:init_To_GPS)_Is_Autorun" -ErrorAction SilentlyContinue) {
			"True" {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendISO" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendISO" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendISOSources" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendISOSources" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendISOSourcesOEM" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendISOSourcesOEM" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendPather" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_AllowUnattendPather" -ErrorAction SilentlyContinue) {
	...
	$SolutionsUnattendOOBEActivate = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SolutionsUnattendOOBEActivate.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsOOBEActivate" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsOOBEActivate" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsOOBEActivate" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsOOBEActivate" -ErrorAction SilentlyContinue) {
	...
	$SolutionsUnattendSetupOSUI = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SolutionsUnattendSetupOSUI.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsSetupUI" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsSetupUI" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsSetupUI" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsSetupUI" -ErrorAction SilentlyContinue) {
	...
	$SolutionsUnattendAccectEula = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SolutionsUnattendAccectEula.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsAccectEula" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsAccectEula" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsAccectEula" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsAccectEula" -ErrorAction SilentlyContinue) {
	...
	$SolutionsUnattendDoNotServerManager = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SolutionsUnattendDoNotServerManager.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsDoNotServerManager" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsDoNotServerManager" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsDoNotServerManager" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsDoNotServerManager" -ErrorAction SilentlyContinue) {
	...
	$SolutionsUnattendIEAdmin = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SolutionsUnattendIEAdmin.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsIEAdmin" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsIEAdmin" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsIEAdmin" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsIEAdmin" -ErrorAction SilentlyContinue) {
	...
	$SolutionsUnattendIEUser = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SolutionsUnattendIEUser.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsIEUser" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsIEUser" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsIEUser" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsIEUser" -ErrorAction SilentlyContinue) {
	...
	$SchemeTimeZoneSelect = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($SchemeTimeZoneSelect.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsTimeZone" -value "True"
				$SchemeTimezoneDynamicButton.Enabled = $True
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_IsTimeZone" -value "False"
	...
	$UI_Command_Not_Class = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($this.Checked) {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Allow_Command_Not_Class" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Allow_Command_Not_Class" -value "False"
			}

			Refresh_Command_Rule_Select_Group
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Allow_Command_Not_Class" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Allow_Command_Not_Class" -ErrorAction SilentlyContinue) {
			"True" {
	...
	$UIUnzipPanel_Error_Unattend_Auto_Fix_Next = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Is_Auto_Fix_Command" -value "True"
	...
	$Engine_Unattend_Auto_Fix = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($this.Checked) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -name "$($Script:init_To_GPS)_Is_Auto_Fix_Command" -value "False"
			}
		}
	}
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Is_Auto_Fix_Command" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Is_Auto_Fix_Command" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Is_Mark_Sync" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Is_Mark_Sync" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Defender" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Defender" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Network_Location_Wizard" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Network_Location_Wizard" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Sync_Volume_Name" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Sync_Volume_Name" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_PreAppxCleanup" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_PreAppxCleanup" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_LanguageComponents" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_LanguageComponents" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_PreventCleaningUnusedLP" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_PreventCleaningUnusedLP" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Desktop_Menu" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Desktop_Menu" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Desktop_Menu_Shift" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Desktop_Menu_Shift" -ErrorAction SilentlyContinue) {
	...
	$EngineRegional    = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			if ($EngineRegional.Checked) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Is_Region" -value "True"
			} else {
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Is_Region" -value "False"
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Prerequisites_Reboot" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Prerequisites_Reboot" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_PopupEngine" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_PopupEngine" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Allow_First_Pre_Experience" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Allow_First_Pre_Experience" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Restricted" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Restricted" -ErrorAction SilentlyContinue) {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_First_Experience_Reboot" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_First_Experience_Reboot" -ErrorAction SilentlyContinue) {
			"True" {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_SaveEngine" -ErrorAction SilentlyContinue) {
		$GetSaveEngine = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_SaveEngine" -ErrorAction SilentlyContinue
	...
	$UI_Main_Event_Clear_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\\Assets\icon\Clear.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = { Solutions_Event_Clear -All }
	}
	...
	$UI_Main_Save_ICO  = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\Assets\icon\Save.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
	...
	$UI_Main_Canel_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\Assets\icon\Cancel.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
	...
	$GroupSolutionsSoftwarePacker.controls.AddRange((
		...
		$SoftwarePackageTo,
		$SoftwarePackageToRoot,
		$SoftwarePackageToSolutions,
		$SoftwarePackageToPublish,
		$GroupSoftwareList,
		$GroupFontsListTitle,
		$GroupFontsList
	))
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_LanguageUnattend" -ErrorAction SilentlyContinue) {
		$SchemeVerSingle.Text = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_LanguageUnattend" -ErrorAction SilentlyContinue
	} else {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_LanguageCollection" -ErrorAction SilentlyContinue) {
		$SchemeLangSingle.Text = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_LanguageCollection" -ErrorAction SilentlyContinue
	} else {
	...
	<#
		.选择解决方案语言包
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsLanguageUnattend" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsLanguageUnattend" -ErrorAction SilentlyContinue) {
			"True" {
	...
	<#
		.选择解决方案语言包
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsLanguageCollection" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsLanguageCollection" -ErrorAction SilentlyContinue) {
			"True" {
	...
	<#
		.添加合集, 更改语言, 语言选择
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -Name "$($Script:init_To_GPS)_Collection_Reserved_Language" -ErrorAction SilentlyContinue) {
		$GetCollectionLanguageOnlyArray = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Collection" -Name "$($Script:init_To_GPS)_Collection_Reserved_Language" -ErrorAction SilentlyContinue
	} else {
		$Verify_Language_New_Path = ISO_Local_Language_Calc
	...
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_CopyTo" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_CopyTo" -ErrorAction SilentlyContinue) {
			"1" {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_Reserved_Language" -ErrorAction SilentlyContinue) {
		$GetTempSelectPacker = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Office" -Name "$($Script:init_To_GPS)_Reserved_Language" -ErrorAction SilentlyContinue
	...
	<#
		.软件包合集
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -Name "SolutionsPacker_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue) {
		$GetTempSelectPacker = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -Name "SolutionsPacker_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue
	...
	<#
		.复选框: 部署软件包合集
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -Name "$($Script:init_To_GPS)_AllowDeployCollection" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -Name "$($Script:init_To_GPS)_AllowDeployCollection" -ErrorAction SilentlyContinue) {
			"True" {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -Name "$($Script:init_To_GPS)_DeployCollectionSelect" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Package" -Name "$($Script:init_To_GPS)_DeployCollectionSelect" -ErrorAction SilentlyContinue) {
	...
	<#
		...
		.复选框: 选择需要加入的软件
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsSoftware" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsSoftware" -ErrorAction SilentlyContinue) {
			"True" {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Software" -Name "$($Script:init_To_GPS)_DeploySoftwareSelect" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Software" -Name "$($Script:init_To_GPS)_DeploySoftwareSelect" -ErrorAction SilentlyContinue) {
			"1" { $SoftwarePackageToRoot.Checked = $True }
			"2" { $SoftwarePackageToSolutions.Checked = $True }
			"3" { $SoftwarePackageToPublish.Checked = $True }
		}
	} else {
		Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Software" -name "$($Script:init_To_GPS)_DeploySoftwareSelect" -value "1"
		$SoftwarePackageToRoot.Checked = $True
	}
	...
	<#
		...
		.复选框: 选择需要加入的字体
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsFonts" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_IsFonts" -ErrorAction SilentlyContinue) {
			"True" {
	...
	<#
		.时间: 将所有已知时间显示到列表里
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_Time_Zone" -ErrorAction SilentlyContinue) {
		$GetSaveTimezone = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_Time_Zone" -ErrorAction SilentlyContinue
		...
		ForEach ($itemRegion in $Region) {
			if ($itemRegion.Region -eq $Global:MainImageLang) {
				...
				Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_Time_Zone" -value $itemRegion.Timezone
				break
			}
		}
	}
					...
					if ($_ -is [System.Windows.Forms.RadioButton]) {
						if ($_.Enabled) {
							if ($_.Checked) {
								...
								Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -name "$($Script:init_To_GPS)_Time_Zone" -value $_.Tag
							}
						}
					}
				}
	...
	<#
		.复选框: 时间区域
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsTimeZone" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_IsTimeZone" -ErrorAction SilentlyContinue) {
			"True" {
	...
	<#
		判断是否需要删除整个解决方案
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_ClearFull" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_ClearFull" -ErrorAction SilentlyContinue) {
			"True" {
			...
			"False" {
				if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Clear" -ErrorAction SilentlyContinue) {
					switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Clear" -ErrorAction SilentlyContinue) {
						"True" {
							$EngineDoneClearFull.Enabled = $True
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Region_UTF8" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create" -Name "$($Script:init_To_GPS)_Region_UTF8" -ErrorAction SilentlyContinue) {
			"True" {
				...
				$GUISolutionsShowLanguage.Controls | ForEach-Object {
					if ($_ -is [System.Windows.Forms.RadioButton]) {
						if ($_.Checked) {
							...
							Save_Dynamic -regkey "Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -name "$($Script:init_To_GPS)_Region_Preferred" -value $_.Tag
						}
					}
				}
			}
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Is_Region" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Create\Mark" -Name "$($Script:init_To_GPS)_Is_Region" -ErrorAction SilentlyContinue) {
			"True" {
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_UnattendMode" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\Unattend" -Name "$($Script:init_To_GPS)_UnattendMode" -ErrorAction SilentlyContinue) {
	...
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -Name "$($Script:init_To_GPS)_OOBE_Select_Init_User" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\ImageSources\$($Global:MainImage)\Deploy\OOBE" -Name "$($Script:init_To_GPS)_OOBE_Select_Init_User" -ErrorAction SilentlyContinue) {
			"Custom" {
		...
		#region 自动驾驶: 合集
			...
			if ($Autopilot.Schome.Collection.Enable) {
				...
				if ($Autopilot.Schome.Collection.Software.IsDeploy) {
					...
					switch ($Autopilot.Schome.Collection.Software.DeployTo) {
						"SystemDisk" {
							$SoftwarePackageToRoot.Checked = $True
						}
						"Solution" {
							$SoftwarePackageToSolutions.Checked = $True
						}
						"PublicDesktop" {
							$SoftwarePackageToPublish.Checked = $True
						}
					}
...
Function Solutions_Copy_Prerequisite
{
	...
	$InitPathTo = $Script:CopySolutionsToRoot
	switch ((Get-Variable -Scope global -Name "DeploySoftwareTo_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue).Value) {
		1 {
			$InitPathTo = $Script:CopySolutionsToRoot
		}
		2 {
			$OSDefaultUser = (Get-Variable -Scope global -Name "Name_Engine_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue).Value
			$InitPathTo = Join-Path -Path $Script:CopySolutionsToRoot -ChildPath "$($OSDefaultUser)"
		}
		3 {
			$InitPathTo = Join-Path -Path $Script:CopySolutionsToRoot -ChildPath "Users\Public\Desktop"
		}
	}
	...
	if ($Global:ArchitecturePack -eq "arm64") {
		if (Test-Path -Path "$($path)\arm64" -PathType Container) {
			Solutions_Copy_Files_To_Prerequisite -From "$($path)\arm64" -ShortPath $ShortPath -To $InitPathTo
		} else {
			if (Test-Path -Path "$($path)\AMD64" -PathType Container) {
				Solutions_Copy_Files_To_Prerequisite -From "$($path)\AMD64" -ShortPath $ShortPath -To $InitPathTo
			} else {
				if (Test-Path -Path "$($path)\x86" -PathType Container) {
					Solutions_Copy_Files_To_Prerequisite -From "$($path)\x86" -ShortPath $ShortPath -To $InitPathTo
				} else {
...
Function Solutions_Copy_Files_To_Prerequisite
{
	...
	switch ((Get-Variable -Scope global -Name "SolutionsLang_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue).Value) {
		"Single" {
			$NewPathTo = Join-Path -Path $To -ChildPath $ShortPath
	...
	if ($Global:ArchitecturePack -eq "AMD64") {
		if (Test-Path -Path "$($PSScriptRoot)\..\..\..\..\_Custom\Office\$($OSDeployOfficeVersion)\amd64\Office\Data\v64.cab" -PathType Leaf) {
			...
			if (Test-Path -Path "$($PSScriptRoot)\..\..\..\..\_Custom\Office\$($OSDeployOfficeVersion)\x86\Office\Data\v32.cab" -PathType Leaf) {
				...
				Write-Host "  $($lang.NoInstallImage)"
				Write-Host "  $($PSScriptRoot)\..\..\..\..\..\_Custom\Office\$($OSDeployOfficeVersion)\x86" -ForegroundColor Red
			}
		}
	}
...
Function Solutions_Copy_Package_Prerequisite
{
	...
	switch ((Get-Variable -Scope global -Name "DeployPackageTo_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue).Value) {
		1 {
			$NewPathTo = Join-Path -Path $Script:CopySolutionsToRoot -ChildPath $GetTempSelectPacker
			Remove_Tree $NewPathTo
			Check_Folder -chkpath $NewPathTo
			Start-Process "robocopy.exe" -argumentlist "`"$($OSDefaultDeployPackerVersion)`" `"$($NewPathTo)`" /E /XO /W:1 /R:1" -wait -WindowStyle Minimized
		}
		2 {
			$NewPathTo = Join-Path -Path $Script:CopySolutionsToRoot -ChildPath "$($OSDefaultUser)\$($GetTempSelectPacker)"
			Remove_Tree $NewPathTo
			Check_Folder -chkpath $NewPathTo
			Start-Process "robocopy.exe" -argumentlist "`"$($OSDefaultDeployPackerVersion)`" `"$($NewPathTo)`" /E /XO /W:1 /R:1" -wait -WindowStyle Minimized
		}
		3 {
			$NewPathTo = Join-Path -Path $Script:CopySolutionsToRoot -ChildPath "Users\Public\Desktop\$($GetTempSelectPacker)"
			Remove_Tree $NewPathTo
			Check_Folder -chkpath $NewPathTo
			Start-Process "robocopy.exe" -argumentlist "`"$($OSDefaultDeployPackerVersion)`" `"$($NewPathTo)`" /E /XO /W:1 /R:1" -wait -WindowStyle Minimized
		}
		...
		add_Click      = {
			...
			ForEach ($item in $SearchKMS) {
				$CheckBox     = New-Object System.Windows.Forms.RadioButton -Property @{
					Height    = 55
					Width     = 460
					Text      = "$($item.Name)`n$($lang.KMSKey): $($item.ProductKey)"
					Tag       = $item.ProductKey
					add_Click = {
						$UI_Main_Error.Text = ""
						$UI_Main_Error_Icon.Image = $null
...
{
	"Author": {
		"Name":          "$($Global:Author)'s Solutions",
	...
	"DeployPacker": {
		"Version":       "$((Get-Variable -Scope global -Name "SolutionsPacker_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue).Value)",
...
Function Solutions_Copy_Unattend_Files_To_Prerequisite
{
	...
	switch ((Get-Variable -Scope global -Name "Autounattend_$($Script:init_To_GPS)" -ErrorAction SilentlyContinue).Value) {
		...
		3 {
			<#
				.Pre-answer solution language: 1 = single language, current Requirementsing; 2 = semi-auto;
