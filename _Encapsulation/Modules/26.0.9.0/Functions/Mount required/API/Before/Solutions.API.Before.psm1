Function API_Before_UI
{
	...
	Function Autopilot_API_Before_UI_Save
	{
		...
		if ($TempSelectFunctionQueue.Count -gt 0) {
			New-Variable -Scope global -Name "Queue_API_Before_Select_$($Global:Primary_Key_Image.Uid)" -Value $TempSelectFunctionQueue -Force
	...
	Function Refres_Event_Tasks_API_Before
	{
		$UI_Main_Select_Function.controls.clear()

		$Temp_Assign_Task_Select = (Get-Variable -Scope global -Name "Queue_API_Before_Select_$($Global:Primary_Key_Image.Uid)" -ErrorAction SilentlyContinue).Value
	...
	$UI_Main_Event_Clear_Click = {
		New-Variable -Scope global -Name "Queue_API_Before_Select_$($Global:Primary_Key_Image.Uid)" -Value @() -Force

		Refres_Event_Tasks_API_Before
	...
	$UI_Main           = New-Object system.Windows.Forms.Form -Property @{
		...
		Height         = 720
		Width          = 1075
		Text           = "$($lang.API): $($lang.Functions_Before)"
	...
	#>
	$UI_Main_Save_Click = {
		if (Autopilot_API_Before_UI_Save) {
