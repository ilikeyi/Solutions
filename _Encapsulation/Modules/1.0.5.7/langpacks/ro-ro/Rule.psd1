ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Marcaj de zonă scurtă
	LanguageRegionLink              = Asociatie regionala
	LanguageNoSelect                = Afișați limbile cunoscute după selectarea sursei imaginii
	...
	LanguageExtractSearchResult     = Rezultatele căutării
	LanguageExtractSearchResultNO   = Niciun rezultat potrivit
	LanguageExtractSearchResultTips = Selectați limba, faceți clic pe butonul "Căutare și potrivire" și verificați dacă conținutul lingvistic pe care doriți să îl adăugați este consecvent. Dacă da, faceți clic pe butonul "Importați" pentru a afișa rezultate instantanee.
	LanguageExtractSearch           = Căutați și potriviți
	LanguageExtractTo               = După importare adăugați la:
'@