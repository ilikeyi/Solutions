ConvertFrom-StringData -StringData @'
	...
	LowAndCurrentError              = Minimum version: {0}, Current version: {1}
	Check_Eligible                  = Meet the criteria
	Check_Version_PSM_Error         = Version error. Please refer to {0}.psm1.Example and upgrade {0}.psm1 and try again.

	Check_OSEnv                     = System environment check
	Check_Image_Bad                 = Check loaded images for corruption
	Check_Need_Fix                  = Damaged items that need repair
	Image_Mount_Mode                = Mount mode
	Image_Mount_Status              = Mount status
	Check_Compatibility             = Compatibility Check
	Check_Duplicate_rule            = Check for duplicate rule entries
	Duplicates                      = Duplicates
	ISO_File                        = ISO files
	ISO_Langpack                    = ISO Language Packs
'@