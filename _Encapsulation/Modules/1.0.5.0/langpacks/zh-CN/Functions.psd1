ConvertFrom-StringData -StringData @'
	...
	Other_Tasks_Clear               = 清除生成的所有
	Other_Tasks_Empty               = 空任务
	Other_Tasks_Pause               = 暂停
	Other_Tasks_RAMDISK             = 搜索本地所有磁盘卷标名为 RADMDISK 后格式化
	Other_Tasks_RAMDISK_AR          = 搜索本地所有磁盘卷标名为 RADMDISK 后格式化 + 自动修复
	Other_Tasks_REFS                = WinPE 添加 REFS 安装支持
	Other_Tasks_TPM                 = 绕过 TPM 安装检查
'@