ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Īsās zonas atzīme
	LanguageRegionLink              = Reģionālā apvienība
	LanguageNoSelect                = Rādīt zināmās valodas pēc attēla avota izvēles
	...
	LanguageExtractSearchResult     = Meklēšanas rezultāti
	LanguageExtractSearchResultNO   = Nav atbilstošu rezultātu
	LanguageExtractSearchResultTips = Atlasiet valodu, noklikšķiniet uz pogas "Meklēt un atbilst" un pārbaudiet, vai valodas saturs, kuru vēlaties pievienot, ir konsekvents. Ja tā, noklikšķiniet uz pogas "Importēt", lai parādītu tūlītējos rezultātus.
	LanguageExtractSearch           = Meklēt un saskaņot
	LanguageExtractAddTo            = Imports
	LanguageExtractTo               = Pēc importēšanas pievienojiet:
'@