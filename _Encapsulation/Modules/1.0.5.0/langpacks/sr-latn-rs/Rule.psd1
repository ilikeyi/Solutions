ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Ознака кратке зоне
	LanguageRegionLink              = Регионално удружење
	LanguageNoSelect                = Прикажи познате језике након избора извора слике
	...
	LanguageExtractSearchResult     = Резултати претраге
	LanguageExtractSearchResultNO   = Нема одговарајућих резултата
	LanguageExtractSearchResultTips = Изаберите језик, кликните на дугме "Тражи и подударај" и проверите да ли је садржај језика који желите да додате конзистентан, кликните на дугме "Увези" да бисте приказали тренутне резултате.
	LanguageExtractSearch           = Тражи и подударај
	LanguageExtractAddTo            = Увоз
	LanguageExtractTo               = Након увоза додајте у:
'@