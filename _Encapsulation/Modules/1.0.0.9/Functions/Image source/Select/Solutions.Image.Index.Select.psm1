...
Function Image_Select_Index_UI
{
	...
	Write-Host "`n   $($lang.SelectSettingImage): $($lang.SelectSettingImage)" -ForegroundColor Yellow
	Write-Host "   $('-' * 80)"
	...
	$UI_Main           = New-Object system.Windows.Forms.Form -Property @{
		...
		Height         = 720
		Width          = 928
		Text           = "$($lang.SelectSettingImage): $($lang.SelectSettingImage)"
