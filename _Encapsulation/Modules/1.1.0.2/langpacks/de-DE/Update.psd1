ConvertFrom-StringData -StringData @'
	...
	SearchOrderTips           = Suchreihenfolge\n  Wenn 12 Bedingungen erfüllt sind, wird die Suche beendet; andernfalls wird sie fortgesetzt.\n\n\n1. Indexnummer\n   Suche nach [ Quelle hinzufügen ]\\Benutzerdefiniert\\[ Übereinstimmende Indexnummer des aktuell eingebundenen Verzeichnisses ]. Bei einem Treffer wird die Datei hinzugefügt und die Suche beendet.\n\n2. Image-Flag\n   Suche nach [ Quelle hinzufügen ]\\Benutzerdefiniert\\[ Aktuell eingebundenes Image-Flag abrufen ]. Bei einem Treffer wird die Datei hinzugefügt und die Suche beendet.\n\n3. Sonstige\n   Wenn keine der 12 Bedingungen erfüllt ist, werden standardmäßig alle Dateien der Quelle hinzugefügt ( mit Ausnahme des Verzeichnisses "Benutzerdefiniert" innerhalb der Quelle ).
'@