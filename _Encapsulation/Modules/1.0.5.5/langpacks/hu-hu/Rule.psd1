ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Rövid zóna jel
	LanguageRegionLink              = Regionális egyesület
	LanguageNoSelect                = Ismert nyelvek megjelenítése a képforrás kiválasztása után
	...
	LanguageExtractSearchResult     = Keresési eredmények
	LanguageExtractSearchResultNO   = Nincsenek megfelelő eredmények
	LanguageExtractSearchResultTips = Válassza ki a nyelvet, kattintson a "Keresés és egyezés" gombra, és ellenőrizze, hogy a hozzáadni kívánt nyelv konzisztens-e. Ha igen, kattintson az "Importálás" gombra az azonnali eredmények megjelenítéséhez.
	LanguageExtractSearch           = Keresés és párosítás
	LanguageExtractTo               = Az importálás után add hozzá:
'@