ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Contrassegno della zona corta
	LanguageRegionLink              = Associazione regionale
	LanguageNoSelect                = Mostra le lingue conosciute dopo aver selezionato la fonte dell'immagine
	...
	LanguageExtractSearchResult     = Risultati della ricerca
	LanguageExtractSearchResultNO   = Nessun risultato corrispondente
	LanguageExtractSearchResultTips = Seleziona la lingua, fai clic sul pulsante "Cerca e abbina" e controlla se il contenuto della lingua che desideri aggiungere è coerente. In tal caso, fai clic sul pulsante "Importa" per visualizzare risultati immediati.
	LanguageExtractSearch           = Cerca e abbina
	LanguageExtractAddTo            = Importare
	LanguageExtractTo               = Dopo l'importazione aggiungi a:
'@