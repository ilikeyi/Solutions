ConvertFrom-StringData -StringData @'
	...
	LanguageShort                   = Oznaka kratke zone
	LanguageRegionLink              = Regionalna udruga
	LanguageNoSelect                = Prikaži poznate jezike nakon odabira izvora slike
	...
	LanguageExtractSearchResult     = Rezultati pretraživanja
	LanguageExtractSearchResultNO   = Nema odgovarajućih rezultata
	LanguageExtractSearchResultTips = Odaberite jezik, kliknite gumb "Traži i spoji" i provjerite je li jezični sadržaj koji želite dodati dosljedan, kliknite gumb "Uvezi" za prikaz trenutačnih rezultata.
	LanguageExtractSearch           = Traži i spajaj
	LanguageExtractAddTo            = Uvoz
	LanguageExtractTo               = Nakon uvoza dodaj u:
'@