...
Function Mainpage
{
	...
	switch -Wildcard ($NewEnter)
	{
		...
		#>
			...
			"isa" {
				Write-Host "`n  $($lang.Short_Cmd)" -ForegroundColor Yellow
				Menu_Shortcuts_Image_Sources_Append
				ToWait -wait 2
				Mainpage
			}
			...
			"isa *" {
				Write-Host "`n  $($lang.Short_Cmd)" -ForegroundColor Yellow
				Menu_Shortcuts_Image_Sources_Append_IAB -Command $PSItem
				ToWait -wait 2
				Mainpage
			}
			...
			"iAE" {
				Write-Host "`n  $($lang.Short_Cmd)" -ForegroundColor Yellow
				Menu_Shortcuts_Additional_Edition
				ToWait -wait 2
				Mainpage
			}
			...
			"iAE *" {
				Write-Host "`n  $($lang.Short_Cmd)" -ForegroundColor Yellow
				Menu_Shortcuts_Additional_Edition_Key -Command $PSItem
				ToWait -wait 2
				Mainpage
			}
