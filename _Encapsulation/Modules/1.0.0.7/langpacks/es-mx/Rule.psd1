ConvertFrom-StringData -StringData @'
	...
	LanguageExtractSearchResultTips = Seleccione un idioma, haga clic en el botón "Buscar y combinar" y verifique si el contenido del idioma que desea agregar es consistente. Si es así, haga clic en el botón "Importar" para mostrar resultados instantáneos.
