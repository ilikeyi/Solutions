	...
	function Image_Additional_Edition_Save
	{
		...
		if ($NewCustom.count -gt 0) {
			...
			if ($UI_Main_Abandon_Allow.Checked) {
				New-Variable -Scope global -Name "AE_Eject_Do_Not_Save_Abandon_Allow_$($Global:Primary_Key_Image.Uid)" -Value $True -Force
			} else {
				New-Variable -Scope global -Name "AE_Eject_Do_Not_Save_Abandon_Allow_$($Global:Primary_Key_Image.Uid)" -Value $False -Force
			}
...
#							$UI_Main_Select_Rule.controls.AddRange($UI_Main_Pre_Rule_Not_Find)
	...
	Function Image_Additional_Edition_Rule_Details_View
	{
		...
		if ($Script:InBox_Apps_Rule_Select_Single.count -gt 0) {
			...
			$UI_Main_Import_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
		}
	}
		...
		$Productkey_Custom  = New-Object system.Windows.Forms.LinkLabel -Property @{
			...
			add_Click      = {
				...
				if ([string]::IsNullOrEmpty($This.Tag)) {
					...
					$UI_Main_Import_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
	...
	$UI_Main_Order_Save_Click = {
		...
		if ($Temp_Get_Select_Order.count -gt 0) {
			...
			$UI_Main_Order_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
		}
	}
	$UI_Main_Order_Save_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "10,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		add_Click      = $UI_Main_Order_Save_Click
	}
	$UI_Main_Order_Save = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 210
		Location       = "36,638"
		Text           = $lang.Save
	...
	$UI_Main_Order_Hide_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "270,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Order_Hide_Click
	}
	$UI_Main_Order_Hide = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 200
		Location       = "296,638"
		Text           = $lang.Hide
	...
	$UI_Main_Import_Show_Order_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "560,560"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Drag.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = {
			$UI_Main_Order_UI.Visible = $True
		}
	...
	$UI_Main_Import_Import_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "560,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Import_Import_Click
	}
	$UI_Main_Import_Import = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 210
		Location       = "586,638"
		Text           = $lang.Import
	...
	$UI_Main_Import_Hide_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "820,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\hide.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Import_Hide_Click
	}
	$UI_Main_Import_Hide = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 200
		Location       = "846,638"
		Text           = $lang.Hide
	...
	$UI_Main_Exclude_Hide_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "820,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\hide.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Exclude_Hide_Click
	}
	$UI_Main_Exclude_Hide = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 200
		Location       = "846,638"
		Text           = $lang.Hide
	...
	<#
		.显示排除项界面
	#>
	$UI_Main_Exclude_UI_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "565,525"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Exclude.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = {
	...
	$UI_Main_View_Import_UI_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "565,560"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Import.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_View_Import_UI_Click
	}
	...
	$UI_Main.controls.AddRange((
		...
		$UI_Main_Exclude_UI_ICO,
		$UI_Main_Exclude_UI,
		$UI_Main_View_Import_UI_ICO,
	...
	$UI_Main_Import_Detailed.controls.AddRange((
		...
		$UI_Main_Import_Show_Order_ICO,
		$UI_Main_Import_Show_Order,
		$UI_Main_Import_Import_ICO,
		$UI_Main_Import_Import,
		$UI_Main_Import_Hide_ICO,
		$UI_Main_Import_Hide
	))
	...
	$UI_Main_Order_UI.controls.AddRange((
		$UI_Main_Order_Name,
		$UI_Main_Order_Rule,
		$UI_Main_Order_Save_ICO,
		$UI_Main_Order_Save,
		$UI_Main_Order_Hide_ICO,
		$UI_Main_Order_Hide,
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\RAMDisk" -Name "RAMDisk" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\RAMDisk" -Name "RAMDisk" -ErrorAction SilentlyContinue) {
			"True" {
				...
				if ((Get-Variable -Scope global -Name "AE_Eject_Do_Not_Save_Abandon_Allow_$($Global:Primary_Key_Image.Uid)" -ErrorAction SilentlyContinue).Value) {
		...
		$LinkLabel         = New-Object system.Windows.Forms.LinkLabel -Property @{
			...
			add_Click      = {
				...
				if ($Temp_Get_Select_Function -contains $this.Text) {
					$UI_Main_Exclude_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
					...
					$UI_Main_Exclude_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
