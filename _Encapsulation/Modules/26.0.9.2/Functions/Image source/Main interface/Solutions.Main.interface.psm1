...
Function Image_Select
{
		...
		if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions" -Name "DiskTo" -ErrorAction SilentlyContinue) {
			...
			if ($GetAddFolderExclude.count -gt 0) {
				...
				if ($GetAddFolderExclude.Count -gt 0) {
					...
					$GUIImageSourceGroupSettingErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Info.png")
		...
		if ($GetALlName.Count -gt 0) {
			...
			if ($FileBrowser.ShowDialog() -eq "OK") {
				...
				if (Test-Path -Path $FileBrowser.FileName -PathType leaf) {
					...
					$GUIImageSourceGroupAPIErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
				} else {
					$GUIImageSourceGroupAPIErrorMsg.Text = "$($lang.Backup): $($FileBrowser.FileName), $($lang.Failed)"
					$GUIImageSourceGroupAPIErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
				}
			} else {
				$GUIImageSourceGroupAPIErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
			...
			try {
				...
				if ($ReadBackupJson.Version.Replace('.', '') -ge $((Get-Module -Name Solutions).PrivateData.PSData.API.MinimumVersion).Replace('.', '')) {
					if ($ReadBackupJson.API.Count -gt 0) {
						...
						$GUIImageSourceGroupAPIErrorMsg.Text = $lang.NoWork
						$GUIImageSourceGroupAPIErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Info.png")
					}
				} else {
	...
	Function Solutions_API_Add_New_Rule_Name
	{
		...
		if (Solutions_API_Verify_New_RuleName) {
			...
			Save_Dynamic -regkey "Solutions\API\Custom\$($GUIImageSourceGroupAPI_Rule_Path.Text)" -name "NoWait" -value $GUIImageSourceGroupAPI_New_No_Wait.Checked
				...
				$CheckboxChange    = New-Object system.Windows.Forms.LinkLabel -Property @{
					...
					add_Click      = {
						...
						if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\API\Custom\$($this.Name)" -Name "Path" -ErrorAction SilentlyContinue) {
							$GetImportFileName = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\API\Custom\$($this.Name)" -Name "Path" -ErrorAction SilentlyContinue
						...
						if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\API\Custom\$($this.Name)" -Name "NoWait" -ErrorAction SilentlyContinue) {
							switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\API\Custom\$($this.Name)" -Name "NoWait" -ErrorAction SilentlyContinue) {
								"True" {
									$GUIImageSourceGroupAPI_New_No_Wait.Checked = $True
								}
								"False" {
									$GUIImageSourceGroupAPI_New_No_Wait.Checked = $False
								}
							}
						} else {
							$GUIImageSourceGroupAPI_New_No_Wait.Checked = $False
	...
	Function Unzip_Custom_Rule_Setting_Default
	{
		...
		if ([string]::IsNullOrEmpty($GUID)) {
			$UIUnzipPanel_Select_Rule_MenuMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
	...
	Function Image_Select_Refresh_Sources_List
	{
		...
		$UI_Main_To_ICO.Visible = $False                # 隐藏: 前往图标
		$UI_Main_Ok_ICO.Visible = $False                # 隐藏: 确定图标
...
#							$GUIImageSourceGroupMountToShow.Text = "$($Global:Image_source)_Custom"
						...
						$UI_Mask_Image_Mount_To_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
					} else  {
						...
						$UI_Mask_Image_Mount_To_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Info.png")
					}
				...
				$UI_Main_Image_Sources_Menu_Show.visible = $False # 隐藏：菜单
				$UI_Main_To_ICO.Visible = $True                # 隐藏: 前往图标
				$UI_Main_Ok_ICO.Visible = $True                # 隐藏: 确定图标
				...
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Go.png")
			}
		}
	}
			...
			if ($UIUnzip_Search_Show_Select.Checked) {
				...
				if ([string]::IsNullOrEmpty($UIUnzip_Search_Sift_Custon.Text)) {
					...
					if ([string]::IsNullOrEmpty($UIUnzip_Search_Sift_Custon.Text)) {
						...
						$UIUnzipPanelErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
						$UIUnzip_Search_Sift_Custon.BackColor = "LightPink"
						return
					}
					...
					if ($Script:Init_Folder_All_File_Exclude.count -gt 0) {
						$UI_Main_Pre_Rule_EjectCdrom= New-Object system.Windows.Forms.LinkLabel -Property @{
							...
							add_Click      = {
								...
								$UIUnzipPanelErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
							}
						}
	...
	<#
		备份 API
	#>
	$GUIImageSourceGroupAPI_Shortcut_Panel_Backup_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "20,590"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\backup.png")
	...
	<#
		还原 API
	#>
	$GUIImageSourceGroupAPI_Shortcut_Panel_Restore_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "20,630"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\restore.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = { Solutions_API_Backup }
	}
	...
	<#
		从注册表读取保存的命名规则: 刷新
	#>
	$GUIImageSourceGroupAPI_Shortcut_Panel_Refresh_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "190,590"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
	...
	<#
		.API: 删除已选
	#>
	$GUIImageSourceGroupAPI_Shortcut_Clear_Select_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "190,630"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\delete.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = { Solutions_API_Backup }
	}
	...
	$GUIImageSourceGroupAPI_New_No_Wait = New-Object System.Windows.Forms.CheckBox -Property @{
		Height         = 30
		Width          = 438
		Padding        = "45,0,0,0"
		Text           = $lang.RuleWaitEnd
		add_Click      = {
			$GUIImageSourceGroupAPIErrorMsg_Icon.Image = $null
			$GUIImageSourceGroupAPIErrorMsg.Text = ""
			$GUIImageSourceGroupAPI_Rule_Path.BackColor = "#FFFFFF"
	...
	$GUIImageSourceGroupAPI_Change_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Edit.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
	...
	$GUIImageSourceGroupAPI_Add_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Add.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		...
		add_Click      = {
			...
			if ([string]::IsNullOrEmpty($GUIImageSourceGroupMountFromPath.Text)) {
				...
				if (Test-Path -Path $GUIImageSourceGroupMountFromPath.Text -PathType Container) {
					...
					$UI_Mask_Image_Mount_To_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
				} else {
	...
	$GUIImageSourceGroupSettingEvent = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			$GUISelectOtherSettingSaveModeErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
		}
	}
	...
	$UI_Main_Image_Sources_Menu = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 20
		SizeMode       = "Zoom"
		Image          = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\menu.png")
		Cursor         = [System.Windows.Forms.Cursors]::Hand
		add_Click      = {
	...
	$GUIImageSourceSetting_Menu = New-Object system.Windows.Forms.Label -Property @{
		...
		$GUIImageSourceSetting_Menu_Capture_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
			Location       = "64,55"
			Height         = 22
			Width          = 22
			SizeMode       = "Zoom"
			Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\capture.png")
		}
		...
		$GUIImageSourceSetting_Menu_Tempate_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
			Location       = "64,95"
			Height         = 22
			Width          = 22
			SizeMode       = "Zoom"
			Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\template.png")
		}
		...
		$GUIImageSourceSetting_Menu_Unpack_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
			Location       = "64,140"
			Height         = 22
			Width          = 22
			SizeMode       = "Zoom"
		...
		$GUIImageSourceSetting_Menu_Unpack_Tips = New-Object system.Windows.Forms.Label -Property @{
			Height         = 35
			Width          = 250
			Text           = "$($Global:Author)'s Solutions"
			Location       = '90,175'
		}
	...
	$GUIImageSourceSetting_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Setting.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
	...
	$UIUnzip_ICO       = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\iso.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
	...
	$UIUnzipPanel_Select_Rule_Filter_arm64 = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			$UIUnzipPanel_Select_Rule_MenuMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
	...
	$UIUnzipPanelRefresh_ico = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\search.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
	...
	$UI_Main_Eject_Cdrom_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Eject.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
	...
	$UIUnzipPanelOK_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		...
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\extract.png")
		Cursor = [System.Windows.Forms.Cursors]::Hand
		...
		add_Click      = {
			...
			if (Test-Path -Path $UIUnzipPanel_To_Path.Text -PathType leaf) {
				...
				if ([string]::IsNullOrEmpty($UIUnzipPanel_SHA256_Calibration.Name)) {
					$UIUnzipPanelErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Info.png")
	...
	$UI_Main_To_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "728,225"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Go.png")
	}
	...
	$UI_Main_Image_Sources_Menu_Show.controls.AddRange((
		...
		$GUIImageSourceSetting_Menu,
			$GUIImageSourceSetting_Menu_Capture_ICO,  # 捕获
			$GUIImageSourceSetting_Menu_Capture,
			$GUIImageSourceSetting_Menu_Tempate_ICO,  # 创建模板
			$GUIImageSourceSetting_Menu_Tempate,
			$GUIImageSourceSetting_Menu_Unpack_ICO,   # 备份
			$GUIImageSourceSetting_Menu_Unpack,
			$GUIImageSourceSetting_Menu_Unpack_Tips
	))

	$GUIImageSourceGroupAPI.controls.AddRange((
		$GUIImageSourceGroupAPI_Shortcut_Name,
		$GUIImageSourceGroupAPI_Shortcut_Panel,
		$GUIImageSourceGroupAPI_Shortcut_Panel_Backup_ICO,
		$GUIImageSourceGroupAPI_Shortcut_Panel_Backup,
		$GUIImageSourceGroupAPI_Shortcut_Panel_Restore_ICO,
		$GUIImageSourceGroupAPI_Shortcut_Panel_Restore,
		$GUIImageSourceGroupAPI_Shortcut_Panel_Refresh_ICO,
		$GUIImageSourceGroupAPI_Shortcut_Panel_Refresh,
		$GUIImageSourceGroupAPI_Shortcut_Clear_Select_ICO,
		$GUIImageSourceGroupAPI_Shortcut_Clear_Select,
		$GUIImageSourceGroupAPISetting_Learn_ICO,
	...
	$GUIImageSourceGroupAPISettingPanel.controls.AddRange((
		...
		$GUIImageSourceGroupAPI_New_No_Wait,
