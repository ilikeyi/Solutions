...
Function UnPack_Create_UI
{
	...
	$UI_Main_Create_ASCSignName = New-Object system.Windows.Forms.LinkLabel -Property @{
		...
		add_Click      = {
			...
			if ($Newgpglistkey.Count -gt 0) {
				...
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Info.png")
			}
		}
	}
		...
		if (Unpack_API_Verify_New_RuleName) {
			if ($IsForce) {
				If (Test-Path -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\Unpack\API\Custom\$($Unpack_API_Rule_Path.Text)") {
					...
					$Unpack_API_ErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
			...
			Save_Dynamic -regkey "Solutions\Unpack\API\Custom\$($Unpack_API_Rule_Path.Text)" -name "NoWait" -value $Unpack_API_New_No_Wait.Checked
			...
			$Unpack_API_ErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.png")
			...
			ForEach ($item in $GetALlName) {
				...
				$CheckboxChange    = New-Object system.Windows.Forms.LinkLabel -Property @{
					...
					add_Click      = {
						...
						if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\Unpack\API\Custom\$($this.Name)" -Name "NoWait" -ErrorAction SilentlyContinue) {
							switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\Unpack\API\Custom\$($this.Name)" -Name "NoWait" -ErrorAction SilentlyContinue) {
								"True" {
									$Unpack_API_New_No_Wait.Checked = $True
								}
								"False" {
									$Unpack_API_New_No_Wait.Checked = $False
								}
							}
						} else {
							$Unpack_API_New_No_Wait.Checked = $False
			...
			try {
				...
				if ($ReadBackupJson.Version.Replace('.', '') -ge $((Get-Module -Name Solutions).PrivateData.PSData.API.MinimumVersion).Replace('.', '')) {
					if ($ReadBackupJson.API.Count -gt 0) {
						...
						$Unpack_API_ErrorMsg.Text = $lang.NoWork
						$Unpack_API_ErrorMsg_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Info.png")
					}
				} else {
	...
	<#
		备份 API
	#>
	$Unpack_API_Setting_Shortcut_Backup_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "20,590"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
	...
	<#
		还原 API
	#>
	$Unpack_API_Setting_Shortcut_Restore_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "20,630"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
	...
	<#
		从注册表读取保存的命名规则: 刷新
	#>
	$Unpack_API_Setting_Shortcut_Refresh_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "190,590"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
	...
	<#
		.API: 删除已选
	#>
	$Unpack_API_Setting_Shortcut_Clear_Select_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "190,630"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
	...
	$Unpack_API_New_No_Wait = New-Object System.Windows.Forms.CheckBox -Property @{
		Height         = 30
		Width          = 438
		Padding        = "45,0,0,0"
	...
	<#
		.API: 修改
	#>
	$Unpack_API_Change_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "575,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
	...
	$Unpack_API_Change = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 125
		Location       = "601,638"
		Text           = $lang.Change
	...
	<#
		.API: 添加
	#>
	$Unpack_API_Add_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "733,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
	...
	$Unpack_API_Add    = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 125
		Location       = "759,638"
		Text           = $lang.AddTo
	...
	$Unpack_API_Hide_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "890,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $Unpack_API_Hide_Click
	}
	$Unpack_API_Hide   = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 125
		Location       = "916,638"
		Text           = $lang.Hide
		...
		If ([String]::IsNullOrEmpty($GetImportFileName)) {
			...
			if (Test-Path -Path $GetImportFileName -PathType leaf) {
				...
				if ($RunRule) {
					...
					Write-Host "  " -NoNewline
					Write-Host " $($lang.Running) " -NoNewline -BackgroundColor White -ForegroundColor Black
					if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\Unpack\API\Custom\$($RuleName)" -Name "NoWait" -ErrorAction SilentlyContinue) {
						switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Solutions\Unpack\API\Custom\$($RuleName)" -Name "NoWait" -ErrorAction SilentlyContinue) {
							"True" {
