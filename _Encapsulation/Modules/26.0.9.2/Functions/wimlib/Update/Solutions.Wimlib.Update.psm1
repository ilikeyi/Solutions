...
Function Wimlib_Extract_And_Update
{
	...
	Function Wimlib_Extract_And_Update_Check_Customize
	{
		...
		if ($AddSources) {
			...
			if ($MarkCheckedAddSources) {
				...
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Error.png")
				$UI_Main_Error.Text = "$($lang.SelectFromError): $($lang.NoChoose) ( $($lang.Pri_Key_Update_To) )"
				return
			}
		}
	...
	$UI_Main_Mask_Report_Save_ToOpen = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 45
		Width          = 450
		Padding        = "14,0,0,0"
		...
		add_Click      = {
			...
			if ([string]::IsNullOrEmpty($UI_Main_Mask_Report_Save_To.Text)) {
				...
				if (Test-Path -Path $UI_Main_Mask_Report_Save_To.Text -PathType Container) {
					Start-Process $UI_Main_Mask_Report_Save_To.Text
	...
	$UI_Main_Select_File_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "620,55"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Select_File_Click
	}
	$UI_Main_Select_File = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 210
		Location       = "646,57"
		Text           = $lang.SelFile
	...
	$UI_Main_Extract_File_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "620,95"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Extract_File_Click
	}
	$UI_Main_Extract_File = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 210
		Location       = "646,97"
	...
	$UI_Main_Update_ICO = New-Object system.Windows.Forms.PictureBox -Property @{
		Location       = "620,635"
		Height         = 22
		Width          = 22
		SizeMode       = "Zoom"
		...
		Cursor = [System.Windows.Forms.Cursors]::Hand
		add_Click      = $UI_Main_Update_Click
	}
	$UI_Main_Update    = New-Object system.Windows.Forms.LinkLabel -Property @{
		Height         = 30
		Width          = 255
		Location       = "646,638"
		Text           = $lang.Update
	...
	$UI_Main.controls.AddRange((
		...
		$UI_Main_Refresh_ICO,
		$UI_Main_Refresh,
		$UI_Main_Select_File_ICO,
		$UI_Main_Select_File,
		$UI_Main_Extract_File_ICO,
	...
	$UI_Main_Mask_Report_Menu.controls.AddRange((
		...
		$UI_Main_Mask_Report_Save_ToOpen,
		...
		if ($Global:SMExt -contains $item.Main.Suffix) {
			...
			if ($item.Main.Uid -eq $Global:Primary_Key_Image.Uid) {
				...
				if ($item.Expand.Count -gt 0) {
					...
					$UI_Main_Select_File.Enabled = $False
