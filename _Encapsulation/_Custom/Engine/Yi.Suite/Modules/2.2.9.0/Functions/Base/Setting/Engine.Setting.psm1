...
Function Setting_UI
{
	...
	$UI_Setting_Auto_Update = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($This.Checked) {
				Save_Dynamic -regkey "Suite\Update" -name "IsAutoUpdate" -value "True"
				$UI_Setting_Auto_Update_Adv.Enabled = $True
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
				$UI_Main_Error.Text = "$($lang.Auto_Update_Allow), $($lang.Enable), $($lang.Done)"
			} else {
				Save_Dynamic -regkey "Suite\Update" -name "IsAutoUpdate" -value "False"
	...
	$UI_Setting_Auto_Update_Check_Setting = New-Object system.Windows.Forms.NumericUpDown -Property @{
		Height         = 30
		Width          = 45
		Location       = '38,5'
		Minimum        = 1
		...
		add_ValueChanged = {
			...
			Save_Dynamic -regkey "Suite\Update" -name "AutoCheckUpdate_Hours" -value $This.Value
			$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
	...
	$UI_Setting_Auto_Update_New_Allow = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($This.Checked) {
				Save_Dynamic -regkey "Suite\Update" -name "IsAutoUpdateNew" -value "True"
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
				$UI_Main_Error.Text = "$($lang.Auto_Update_New_Allow), $($lang.Enable), $($lang.Done)"
			} else {
				Save_Dynamic -regkey "Suite\Update" -name "IsAutoUpdateNew" -value "False"
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
	...
	$UI_Setting_Auto_Update_Clean = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($This.Checked) {
				Save_Dynamic -regkey "Suite\Update" -name "IsUpdate_Clean_Allow" -value "True"
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
				$UI_Main_Error.Text = "$($lang.UpdateClean), $($lang.Enable), $($lang.Done)"
			} else {
				Save_Dynamic -regkey "Suite\Update" -name "IsUpdate_Clean_Allow" -value "False"
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
	...
	$UI_Setting_Auto_Update_Adv.Controls.AddRange((
		$UI_Setting_Auto_Update_Check_Setting,
	...
	<#
		.允许自动清理旧版本
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "IsUpdate_Clean_Allow" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "IsUpdate_Clean_Allow" -ErrorAction SilentlyContinue) {
	...
	<#
		.允许自动更新
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "IsAutoUpdate" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "IsAutoUpdate" -ErrorAction SilentlyContinue) {
			"True"  {
	...
	<#
		.允许自动更新新版本
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "IsAutoUpdateNew" -ErrorAction SilentlyContinue) {
		switch (Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "IsAutoUpdateNew" -ErrorAction SilentlyContinue) {
	...
	<#
		.自动检查更新间隔小时
	#>
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "AutoCheckUpdate_Hours" -ErrorAction SilentlyContinue) {
		$UI_Setting_Auto_Update_Check_Setting.Value = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\Suite\Update" -Name "AutoCheckUpdate_Hours" -ErrorAction SilentlyContinue
	} else {
		Save_Dynamic -regkey "Suite\Update" -name "AutoCheckUpdate_Hours" -value "2"
		$UI_Setting_Auto_Update_Check_Setting.Value = 2
	}
	#endregion
