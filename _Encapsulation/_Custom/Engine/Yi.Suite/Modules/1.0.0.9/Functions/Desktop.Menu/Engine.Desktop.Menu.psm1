...
Function Personalise
{
	...
	if ($Add) {
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\$((Get-Module -Name Engine).Author).Dir\command" -Name '(default)' -Value "explorer $(Convert-Path -Path "$($PSScriptRoot)\..\..\..\..\.." -ErrorAction SilentlyContinue)" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
