...
Vector original file, document version Illustator 2020, open it with Adobe Illustrator 2024 or higher <a href="https://github.com/ilikeyi/Solutions/raw/refs/heads/main/_Learn/Screenshots/Technique/Technique.ai">Github</a> | <a href="https://fengyi.tel/download/solutions/Screenshots/Technique/Technique.ai">Yi</a>
</li>
      </ul>
 </li>
 </li>
...
<details>
  ...
  <ul>
    <dd>
      ...
      <dl>
        <dd>1.1.&nbsp;&nbsp;Online updates are enabled by default to ensure the software remains up-to-date through automatic background updates.</dd>
        <dd>1.2.&nbsp;&nbsp;Refresh all modules, shortcut command: R = fast hot refresh, R'R = include other when hot refresh</dd>
        ...
        <dd>1.5.&nbsp;&nbsp;API: Application Programming Interface
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Learn<br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[API.docx](https://github.com/ilikeyi/solutions/blob/main/_Learn/API/API.docx)
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[API.pdf](https://github.com/ilikeyi/solutions/blob/main/_Learn/API/API.pdf)
</p>
        </dd>
        <dd>1.6.&nbsp;&nbsp;Event: Autonomous driving, custom assignment of known events
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Learn<br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Autopilot profile](https://github.com/ilikeyi/solutions/blob/main/_Learn/Autopilot.profile/Autopilot_Profile.pdf)
</p>
        </dd>
        ...
        <dd>
          ...
          <dl>
            <dd>2.2.1.&nbsp;&nbsp;No need to mount image
              <dl>
                <dd>2.2.1.1.&nbsp;&nbsp;Append, Delete, Update files within the image, Extract, Rebuild, Apply, Capture, Additional edition</dd>
...
<br>
    <dd>
      <p>3.&nbsp;&nbsp;Autopilot</p>
      <dl>
        <dd>3.1.&nbsp;&nbsp;Windows 11 24H2 and 25H2: Autopilot packaging, offline multi-language packaging
            <dl>
               <dd>

[Youtube](https://youtu.be/edGtIWY76YI) | [Bilibili](https://www.bilibili.com/video/BV1ioi6BAEzb/) | [Tencent Video](https://v.qq.com/x/page/u31853dpucj.html) | [iQiyi](http://www.iqiyi.com/v_1b8a33l5rrg.html) | [Sohu](http://my.tv.sohu.com/us/201441345/692632967.shtml) | [YouKu](https://v.youku.com/v_show/id_XNjUxODQ2OTkyMA==.html)
               </dd>
            </dl>
         </dd>
      </dl>
