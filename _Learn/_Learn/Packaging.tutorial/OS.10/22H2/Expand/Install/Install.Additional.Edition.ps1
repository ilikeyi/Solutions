$AdditionalEdition = @{
	...
	Rule = @(
		...
		@{ Name = "Windows 10 Pro Education N";                             Requiredversion = "ProfessionalN"; NewEditionId = "ProfessionalEducationN";   Productkey = ""; Detailed = @{ ImageName = "Auto"; Description = "Auto"; DisplayName = "Auto"; DisplayDescription = "Auto"; }; }
