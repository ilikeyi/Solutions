...
Split-WindowsImage -ImagePath "D:\OS_11\sources\install.wim" -SplitImagePath "D:\OS_11\sources\install.swm" -FileSize "4096" -CheckIntegrity -ErrorAction SilentlyContinue | Out-Null
