...
Get-WindowsImage -ImagePath "D:\OS_11\Sources\install.esd" -ErrorAction SilentlyContinue | ForEach-Object {
    ...
    try {
        Export-WindowsImage -SourceImagePath "D:\OS_11\Sources\install.esd" -SourceIndex $_.ImageIndex -DestinationImagePath "D:\OS_11\Sources\install.wim" -CompressionType "Max" -CheckIntegrity -ErrorAction SilentlyContinue | Out-Null
