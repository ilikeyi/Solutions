$AdditionalEdition = @{
	...
	Rule = @(
		...
		@{ Name = "Windows 11 Pro Education N";                             Requiredversion = "Professional";  NewEditionId = "ProfessionalEducationN";   Productkey = ""; Detailed = @{ ImageName = "Auto"; Description = "Auto"; DisplayName = "Auto"; DisplayDescription = "Auto"; }; }
