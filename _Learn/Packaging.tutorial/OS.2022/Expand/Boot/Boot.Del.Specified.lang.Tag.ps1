$Lang = "en-US"
$Mount = "D:\ISOTemp_Custom\Boot\Boot\Mount"
$Sources = "D:\ISOTemp_Custom\Boot\Boot\Language\Del\en-US"
...
$Language = @(
    ...
    @{ Match = "*Fonts-Hans*"; File = "Microsoft-Windows-LanguageFeatures-Fonts-Hans-Package~31bf3856ad364e35~amd64~~.cab"; }
)
