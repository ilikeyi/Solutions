...
Split-WindowsImage -ImagePath "D:\OS_2022\sources\install.wim" -SplitImagePath "D:\OS_2022\sources\install.swm" -FileSize "4096" -CheckIntegrity -ErrorAction SilentlyContinue | Out-Null
