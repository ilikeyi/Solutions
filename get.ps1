...
Function Installation_interface_UI
{
	...
	Function Install_Init_Disk_To
	{
		switch ($UI_Main_Install_To.SelectedItem.Path) {
			"AutoSelectDisk" {}
			"Desktop" {
				Save_Dynamic -regkey "Solutions\Get" -name "InstlTo" -value "Desktop" -String
				return Join-Path -Path $([Environment]::GetFolderPath("Desktop")) -ChildPath $Default_directory_name
			}
			"Download" {
				Save_Dynamic -regkey "Solutions\Get" -name "InstlTo" -value "Download" -String
			...
			"Documents" {
				Save_Dynamic -regkey "Solutions\Get" -name "InstlTo" -value "Documents" -String
			...
			default {
				if (Get-ItemProperty -Path "HKCU:\SOFTWARE\Yi\Solutions\Get" -Name "Instl_To_Custom" -ErrorAction SilentlyContinue) {
					...
					Save_Dynamic -regkey "Solutions\Get" -name "InstlTo" -value $GetNewInstallTo -String
		...
		Save_Dynamic -regkey "Solutions\Get" -name "InstlTo" -value "AutoSelectDisk" -String
		$ExcludeDisk = @(
		...
		add_Click      = {
			...
			if ($FolderBrowser.ShowDialog() -eq "OK") {
				if (Test_Available_Disk -Path $FolderBrowser.SelectedPath) {
					...
					Save_Dynamic -regkey "Solutions\Get" -name "Instl_To_Custom" -value $UI_Main_Save_To_Path.Text -String
					Save_Dynamic -regkey "Solutions\Get" -name "InstlTo" -value $UI_Main_Save_To_Path.Text -String
	...
	$TakeOwnership     = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($TakeOwnership.Checked) {
				Save_Dynamic -regkey "Solutions\Get" -name "TakeOwnership" -value "True" -String
			} else {
				Save_Dynamic -regkey "Solutions\Get" -name "TakeOwnership" -value "False" -String
			}
		}
	}
	...
	$UI_Main_Adv_Safety_Warnings = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($UI_Main_Adv_Safety_Warnings.Checked) {
				Save_Dynamic -regkey "Solutions\Get" -name "Safety_Warnings" -value "True" -String
			} else {
				Save_Dynamic -regkey "Solutions\Get" -name "Safety_Warnings" -value "False" -String
			}
		}
	}
	...
	$UI_Main_Adv_Env   = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($UI_Main_Adv_Env.Checked) {
				Save_Dynamic -regkey "Solutions\Get" -name "Env" -value "True" -String
			} else {
				Save_Dynamic -regkey "Solutions\Get" -name "Env" -value "False" -String
			}
		}
	}
