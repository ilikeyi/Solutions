...
$AvailableLanguages = @(
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Lortu Yi's Solutions sarean"
			...
			AddEnv                   = "Gehitu bideratze funtzionaltasuna sistemaren aldagaiei"
			AddEnvTips               = "Gehitu ondoren, idatzi Yi edozein PowerShell saiotan erantzuteko. Adibidez, idatzi ""Yi -SIP"" paketea exekutatzeko."
			Ok_Go_To                 = "Eskuragarri"
			Ok_Go_To_Main            = "programa nagusia"
			Ok_Go_To_No              = "Ez joan"
			OK_Go_To_Sip             = "paketeen gidoia"
			OK_Go_To_Tempate         = "Sortu txantiloia"
			OK_Go_To_Engline_Update  = "Sortu hedapen-motorra eguneratzeko pakete bat"
			OK_Go_To_Unpack          = "Pack"
			Wait_Select_Add_Del      = "Gehitu instalazioan gaitu ondoren edo orain: "
			ContextMenu              = "testuinguru-menua"
			TakeOwnership            = "jabetu"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obtén Yi's Solutions en liña"
			...
			AddEnv                   = "Engade a funcionalidade de enrutamento ás variables do sistema"
			AddEnvTips               = "Despois de engadir, introduza Yi en calquera sesión de PowerShell para responder. Por exemplo, introduza ""Yi -SIP"" para executar o paquete."
			Ok_Go_To                 = "Dispoñible para"
			Ok_Go_To_Main            = "programa principal"
			Ok_Go_To_No              = "Non vai"
			OK_Go_To_Sip             = "script do paquete"
			OK_Go_To_Tempate         = "Crear modelo"
			OK_Go_To_Engline_Update  = "Crea un paquete de actualización do motor de implementación"
			OK_Go_To_Unpack          = "Pack"
			Wait_Select_Add_Del      = "Engadir durante a instalación despois de activar ou agora: "
			ContextMenu              = "menú contextual"
			TakeOwnership            = "tomar a propiedade"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Dapatkan Yi's Solutions secara online"
			...
			AddEnv                   = "Tambahkan fungsionalitas perutean ke variabel sistem"
			AddEnvTips               = "Setelah menambahkan, masukkan Yi di sesi PowerShell mana pun untuk merespons. Misalnya, masukkan ""Yi -SIP"" untuk menjalankan paket."
			Ok_Go_To                 = "Tersedia untuk"
			Ok_Go_To_Main            = "program utama"
			Ok_Go_To_No              = "Tidak pergi"
			OK_Go_To_Sip             = "skrip paket"
			OK_Go_To_Tempate         = "Buat templat"
			OK_Go_To_Engline_Update  = "Buat paket peningkatan mesin penerapan"
			OK_Go_To_Unpack          = "Mengemas"
			Wait_Select_Add_Del      = "Tambahkan selama instalasi setelah diaktifkan atau sekarang: "
			ContextMenu              = "menu konteks"
			TakeOwnership            = "mengambil kepemilikan"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Nhận trực tuyến Yi's Solutions"
			...
			AddEnv                   = "Thêm chức năng định tuyến vào các biến hệ thống"
			AddEnvTips               = "Sau khi thêm, hãy nhập Yi vào bất kỳ phiên PowerShell nào để phản hồi. Ví dụ: nhập ""Yi -SIP"" để chạy gói."
			Ok_Go_To                 = "Có sẵn để"
			Ok_Go_To_Main            = "chương trình chính"
			Ok_Go_To_No              = "Không đi"
			OK_Go_To_Sip             = "kịch bản gói"
			OK_Go_To_Tempate         = "Tạo mẫu"
			OK_Go_To_Engline_Update  = "Tạo gói nâng cấp công cụ triển khai"
			OK_Go_To_Unpack          = "Đóng gói"
			Wait_Select_Add_Del      = "Thêm trong khi cài đặt sau khi kích hoạt hoặc ngay bây giờ: "
			ContextMenu              = "trình đơn ngữ cảnh"
			TakeOwnership            = "nắm quyền sở hữu"
			Unpacking                = "Giải nén"
			Running                  = "Đang chạy"
			SaveTo                   = "lưu vào"
			OK                       = "Chắc chắn"
...
Function Installation_interface_UI
{
	...
	$UI_Main_ContextMenu_Wrap = New-Object system.Windows.Forms.Label -Property @{
		Height         = 20
		Width          = 480
	}
